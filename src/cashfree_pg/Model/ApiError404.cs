...
namespace cashfree_pg.Model
{
    ...
    public class ApiError404 : IEquatable<ApiError404>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiError404(string? message = default(string?), string? code = default(string?), string? help = default(string?), TypeEnum? type = default(TypeEnum?))
        {
        ...
        {
            return this.Equals(input as ApiError404);
        }

        /// <summary>
        /// Returns true if ApiError404 instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiError404 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiError404 input)
        {
            if (input == null)
            {
                return false;
