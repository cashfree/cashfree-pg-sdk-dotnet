...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class OfferWallet : IValidatableObject
    {
        /// <summary>
        ...
        public OfferWallet(WalletOffer  = default(WalletOffer))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for OfferWallet and cannot be null");
            }
            this.app = ;
        }
