...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SettlementReconEntity_data_inner_order_details")]
    public class SettlementReconEntityDataInnerOrderDetails : IEquatable<SettlementReconEntityDataInnerOrderDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SettlementReconEntityDataInnerOrderDetails" /> class.
        /// </summary>
        ...
        /// <param name="orderCurrency">Order Curreny type - INR..</param>
        /// <param name="orderTags">The order tags provided during order creation.</param>
        public SettlementReconEntityDataInnerOrderDetails(string? orderId = default(string?), decimal? orderAmount = default(decimal?), string? orderCurrency = default(string?), Object? orderTags = default(Object?))
        {
        ...
        {
            return this.Equals(input as SettlementReconEntityDataInnerOrderDetails);
        }

        /// <summary>
        /// Returns true if SettlementReconEntityDataInnerOrderDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SettlementReconEntityDataInnerOrderDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SettlementReconEntityDataInnerOrderDetails input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.order_tags.Equals(input.order_tags))
                );
        }
