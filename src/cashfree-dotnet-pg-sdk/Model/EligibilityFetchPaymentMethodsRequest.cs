...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class EligibilityFetchPaymentMethodsRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">.</param>
        public EligibilityFetchPaymentMethodsRequest(PaymentMethodsQueries  = default(PaymentMethodsQueries), PaymentMethodsFilters?  = default(PaymentMethodsFilters?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EligibilityFetchPaymentMethodsRequest and cannot be null");
            }
            this.queries = ;
            this.filters = ;
        }
