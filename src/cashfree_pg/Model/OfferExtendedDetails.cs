...
namespace cashfree_pg.Model
{
    ...
    public class OfferExtendedDetails : IEquatable<OfferExtendedDetails>, IValidatableObject
    {
        /// <summary>
        ...
        public OfferExtendedDetails(string? offerId = default(string?), string? offerStatus = default(string?), OfferMeta? offerMeta = default(OfferMeta?), OfferTnc? offerTnc = default(OfferTnc?), OfferDetails? offerDetails = default(OfferDetails?), OfferValidations? offerValidations = default(OfferValidations?))
        {
        ...
        {
            return this.Equals(input as OfferExtendedDetails);
        }

        /// <summary>
        /// Returns true if OfferExtendedDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of OfferExtendedDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OfferExtendedDetails input)
        {
            if (input == null)
            {
                return false;
