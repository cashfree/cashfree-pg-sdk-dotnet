...
namespace cashfree_pg.Model
{
    ...
    public class CreateSubscriptionRequestPlanDetails : IValidatableObject
    {
        ...
        /// <param name="planCurrency">INR by default. For subscriptions in non-INR currency, please refer to [supported currencies](https://www.cashfree.com/docs/payments/international-payments/ipg/currencies-supported#full-currency-list)..</param>
