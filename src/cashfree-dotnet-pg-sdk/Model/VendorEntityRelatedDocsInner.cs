...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class VendorEntityRelatedDocsInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public VendorEntityRelatedDocsInner(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.vendor_id = ;
            this.doc_type = ;
            this.doc_value = ;
