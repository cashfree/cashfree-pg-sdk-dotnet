...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentMethodUPIInPaymentsEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodUPIInPaymentsEntity" /> class.
        /// </summary>
        /// <param name="">.</param>
        public PaymentMethodUPIInPaymentsEntity(PaymentMethodUPIInPaymentsEntityUpi?  = default(PaymentMethodUPIInPaymentsEntityUpi?))
        {
            this.upi = ;
        }
