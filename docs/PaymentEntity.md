...
------------ | ------------- | ------------- | -------------
**cf_payment_id** | **string** | Payment entity full object. | [optional] 
...
**bank_reference** | **string** | Issuing bank’s transaction reference number. | [optional] 
**auth_id** | **string** | Authorisation ID provided by the issuing bank. | [optional] 
