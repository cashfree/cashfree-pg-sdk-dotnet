...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class ChargesDetails : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public ChargesDetails(decimal?  = default(decimal?), decimal?  = default(decimal?), decimal?  = default(decimal?), string?  = default(string?), bool?  = default(bool?))
        {
