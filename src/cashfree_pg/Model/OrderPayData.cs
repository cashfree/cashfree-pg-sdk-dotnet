...
namespace cashfree_pg.Model
{
    ...
    public class OrderPayData : IEquatable<OrderPayData>, IValidatableObject
    {
        ...
        /// <param name="redirectToBank">redirectToBank.</param>
        ...
        public bool Equals(OrderPayData input)
        {
            ...
            return 
                ...
                (
                    this.redirect_to_bank == input.redirect_to_bank ||
                    (this.redirect_to_bank != null &&
                    this.redirect_to_bank.Equals(input.redirect_to_bank))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.redirect_to_bank != null)
                {
                    hashCode = (hashCode * 59) + this.redirect_to_bank.GetHashCode();
                }
                return hashCode;
            }
        }
