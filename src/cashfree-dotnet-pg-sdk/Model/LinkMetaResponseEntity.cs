...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class LinkMetaResponseEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkMetaResponseEntity" /> class.
        /// </summary>
        /// <param name="">Notification URL for server-server communication. It should be an https URL..</param>
        /// <param name="">If \&quot;true\&quot;, link will directly open UPI Intent flow on mobile, and normal link flow elsewhere..</param>
        /// <param name="">The URL to which user will be redirected to after the payment is done on the link. Maximum length: 250..</param>
        /// <param name="">Allowed payment modes for this link. Pass comma-separated values among following options - \&quot;cc\&quot;, \&quot;dc\&quot;, \&quot;ccc\&quot;, \&quot;ppc\&quot;, \&quot;nb\&quot;, \&quot;upi\&quot;, \&quot;paypal\&quot;, \&quot;app\&quot;. Leave it blank to show all available payment methods..</param>
        public LinkMetaResponseEntity(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.notify_url = ;
            this.upi_intent = ;
            this.return_url = ;
