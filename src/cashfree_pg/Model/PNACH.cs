...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PNACH")]
    public class PNACH : IEquatable<PNACH>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PNACH" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PNACH);
        }

        /// <summary>
        /// Returns true if PNACH instances are equal
        /// </summary>
        /// <param name="input">Instance of PNACH to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PNACH input)
        {
            if (input == null)
            {
                return false;
