...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class ReconEntityDataInnerCustomerDetails : IValidatableObject
    {
        ...
        /// <param name="">Customer&#39;s id..</param>
        /// <param name="">Customer bank account number..</param>
        /// <param name="">Customer bank code..</param>
        /// <param name="">Customer bank ifsc.\&quot;..</param>
        public ReconEntityDataInnerCustomerDetails(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.customer_phone = ;
            this.customer_email = ;
            this.customer_name = ;
