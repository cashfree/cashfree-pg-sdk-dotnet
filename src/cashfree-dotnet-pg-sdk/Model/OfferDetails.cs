...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class OfferDetails : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="OfferDetails" /> class.
        /// </summary>
        /// <param name="">Offer Type for the Offer. (required).</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        public OfferDetails(OfferTypeEnum  = default(OfferTypeEnum), DiscountDetails?  = default(DiscountDetails?), CashbackDetails?  = default(CashbackDetails?))
        {
            this.offer_type = ;
