    ...
    public class OrderEntity : IEquatable<OrderEntity>, IValidatableObject
    {
        ...
        public bool Equals(OrderEntity input)
        {
            ...
            return 
                ...
                (
                    this.terminal_data == input.terminal_data ||
                    (this.terminal_data != null &&
                    this.terminal_data.Equals(input.terminal_data))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.terminal_data != null)
                {
                    hashCode = (hashCode * 59) + this.terminal_data.GetHashCode();
                }
