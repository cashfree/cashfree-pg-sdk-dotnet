...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CashbackDetails : IValidatableObject
    {
        /// <summary>
        /// Type of discount.
        /// </summary>
        ...
        /// <param name="">Maximum Value of Cashback allowed. (required).</param>
        public CashbackDetails(CashbackTypeEnum  = default(CashbackTypeEnum), decimal  = default(decimal), decimal  = default(decimal))
        {
            this.cashback_type = ;
            this.cashback_value = ;
