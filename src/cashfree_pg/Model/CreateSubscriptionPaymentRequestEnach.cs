...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSubscriptionPaymentRequestEnach")]
    public class CreateSubscriptionPaymentRequestEnach : IEquatable<CreateSubscriptionPaymentRequestEnach>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionPaymentRequestEnach" /> class.
        /// </summary>
        ...
        public CreateSubscriptionPaymentRequestEnach(string? accountBankCode = default(string?), string? accountHolderName = default(string?), string? accountIfsc = default(string?), string? accountNumber = default(string?), string? accountType = default(string?), string? authMode = default(string?), string? channel = default(string?))
        {
        ...
        {
            return this.Equals(input as CreateSubscriptionPaymentRequestEnach);
        }

        /// <summary>
        /// Returns true if CreateSubscriptionPaymentRequestEnach instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSubscriptionPaymentRequestEnach to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSubscriptionPaymentRequestEnach input)
        {
            if (input == null)
            {
                return false;
