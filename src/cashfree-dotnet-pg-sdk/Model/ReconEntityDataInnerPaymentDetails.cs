...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReconEntity_data_inner_payment_details")]
    public class ReconEntityDataInnerPaymentDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReconEntityDataInnerPaymentDetails" /> class.
        /// </summary>
        /// <param name="">Payment amount captured..</param>
        /// <param name="">Payment Curreny type - INR..</param>
        /// <param name="">Unique transaction reference number of the payment..</param>
        /// <param name="">Date and time when the payment was initiated..</param>
        /// <param name="">Mode of the payment..</param>
        /// <param name="">Service charge applicable for the payment..</param>
        /// <param name="">Service tax applicable on the payment..</param>
        /// <param name="">Cashfree Payments unique ID to identify a payment..</param>
        /// <param name="">Status of the Payment..</param>
        /// <param name="">Forex Conversion Service Charge..</param>
        /// <param name="">Forex Conversion Service Tax..</param>
        /// <param name="">Forex Charges Curreny type - INR..</param>
        public ReconEntityDataInnerPaymentDetails(decimal?  = default(decimal?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), decimal?  = default(decimal?), decimal?  = default(decimal?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            ...
            this.payment_time = ;
            this.payment_group = ;
            this.payment_service_charge = ;
            this.payment_service_tax = ;
            this.cf_payment_id = ;
            this.status = ;
