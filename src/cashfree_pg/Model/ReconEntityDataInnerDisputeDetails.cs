...
namespace cashfree_pg.Model
{
    ...
    public class ReconEntityDataInnerDisputeDetails : IValidatableObject
    {
        ...
        public ReconEntityDataInnerDisputeDetails(string? closedInFavorOf = default(string?), string? disputeResolvedOn = default(string?), string? disputeCategory = default(string?), string? disputeNote = default(string?))
        {
