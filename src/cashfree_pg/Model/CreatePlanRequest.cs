...
namespace cashfree_pg.Model
{
    ...
    public class CreatePlanRequest : IValidatableObject
    {
        ...
        /// <param name="planCurrency">Currency of the plan. For plans in non-INR currency, please refer to [supported currencies](https://www.cashfree.com/docs/payments/international-payments/ipg/currencies-supported#full-currency-list)..</param>
