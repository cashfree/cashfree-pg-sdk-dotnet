...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CreateOrderRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CreateOrderRequest" /> class.
        /// </summary>
        /// <param name="">Order identifier present in your system. Alphanumeric, &#39;_&#39; and &#39;-&#39; only..</param>
        /// <param name="">Bill amount for the order. Provide upto two decimals. 10.15 means Rs 10 and 15 paisa. For orders in non-INR currency, please refer to [supported amounts](https://www.cashfree.com/docs/payments/international-payments/ipg/currencies-supported#decimal-support) per currency. (required).</param>
        /// <param name="">Currency for the order. INR if left empty. For support currency list, refer [here](https://www.cashfree.com/docs/payments/international-payments/ipg/currencies-supported#full-currency-list). Submit [Support Form](https://merchant.cashfree.com/auth/login) to enable new currencies. (required).</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">Time after which the order expires. Customers will not be able to make the payment beyond the time specified here. We store timestamps in IST, but you can provide them in a valid ISO 8601 time format. Example 2021-07-02T10:20:12+05:30 for IST, 2021-07-02T10:20:12Z for UTC.</param>
        /// <param name="">Order note for reference..</param>
        ...
        /// <param name="">.</param>
        public CreateOrderRequest(string?  = default(string?), double  = default(double), string  = default(string), CartDetails?  = default(CartDetails?), CustomerDetails?  = default(CustomerDetails?), TerminalDetails?  = default(TerminalDetails?), OrderMeta?  = default(OrderMeta?), string?  = default(string?), string?  = default(string?), Dictionary<string, string>?  = default(Dictionary<string, string>?), List<VendorSplit>?  = default(List<VendorSplit>?), Products?  = default(Products?))
        {
            this.order_amount = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CreateOrderRequest and cannot be null");
            }
            this.order_currency = ;
            this.order_id = ;
            this.cart_details = ;
