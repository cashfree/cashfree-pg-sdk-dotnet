...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CustomerDetailsCardlessEMI : IValidatableObject
    {
        ...
        public CustomerDetailsCardlessEMI(string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CustomerDetailsCardlessEMI and cannot be null");
            }
            this.customer_phone = ;
        }
