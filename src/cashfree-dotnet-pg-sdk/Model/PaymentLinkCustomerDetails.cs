...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentLinkCustomerDetails : IValidatableObject
    {
        /// <summary>
        ...
        public PaymentLinkCustomerDetails(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), decimal?  = default(decimal?))
        {
            this.customer_id = ;
            this.customer_email = ;
            this.customer_phone = ;
