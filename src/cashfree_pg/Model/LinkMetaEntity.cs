...
namespace cashfree_pg.Model
{
    ...
    public class LinkMetaEntity : IEquatable<LinkMetaEntity>, IValidatableObject
    {
        ...
        public LinkMetaEntity(string notifyUrl = default(string), bool upiIntent = default(bool), string returnUrl = default(string), string paymentMethods = default(string))
        {
