...
namespace cashfree_pg.Model
{
    ...
    public class CryptogramEntity : IValidatableObject
    {
        ...
        /// <param name="tokenRequestorId">TRID issued by respective card networks..</param>
        /// <param name="cardNumber">Token number..</param>
        /// <param name="cardExpiryMm">Token expiry month..</param>
        /// <param name="cardExpiryYy">Token expiry year..</param>
        /// <param name="cryptogram">A one-time code dynamically generated by the respective card network, required to process saved card payments..</param>
        /// <param name="cardDisplay">Displays the last four digits of the actual card number..</param>
