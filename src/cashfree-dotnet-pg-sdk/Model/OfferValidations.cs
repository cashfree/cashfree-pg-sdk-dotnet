...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class OfferValidations : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">Maximum Amount for Offer to be Applicable. (required).</param>
        /// <param name=""> (required).</param>
        public OfferValidations(decimal?  = default(decimal?), decimal  = default(decimal), OfferValidationsResponsePaymentMethod  = default(OfferValidationsResponsePaymentMethod))
        {
            this.max_allowed = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for OfferValidations and cannot be null");
            }
            this.payment_method = ;
            this.min_amount = ;
        }
