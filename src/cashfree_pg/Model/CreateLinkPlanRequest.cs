...
namespace cashfree_pg.Model
{
    ...
    public class CreateLinkPlanRequest : IValidatableObject
    {
        ...
        /// <param name="planIntervals">Number of billing cycles between charges..</param>
        ...
        public CreateLinkPlanRequest(string planId = default(string), string planName = default(string), string planType = default(string), string? planCurrency = default(string?), decimal? planAmount = default(decimal?), decimal planMaxAmount = default(decimal), int? planMaxCycles = default(int?), int? planIntervals = default(int?), string? planIntervalType = default(string?), string? planNote = default(string?))
        {
            // to ensure "planId" is required (not null)
            if (planId == null)
            {
                throw new ArgumentNullException("planId is a required property for CreateLinkPlanRequest and cannot be null");
            }
            this.plan_id = planId;
            // to ensure "planName" is required (not null)
            if (planName == null)
            {
                throw new ArgumentNullException("planName is a required property for CreateLinkPlanRequest and cannot be null");
            }
            this.plan_name = planName;
            // to ensure "planType" is required (not null)
            if (planType == null)
            {
                throw new ArgumentNullException("planType is a required property for CreateLinkPlanRequest and cannot be null");
            }
