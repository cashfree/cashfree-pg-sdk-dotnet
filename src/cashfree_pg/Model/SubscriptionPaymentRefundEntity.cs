...
namespace cashfree_pg.Model
{
    ...
    public class SubscriptionPaymentRefundEntity : IValidatableObject
    {
        ...
        /// <param name="refundNote">Refund note for merchant reference..</param>
        /// <param name="refundSpeed">Refund speed. Can be INSTANT or NORMAL..</param>
        /// <param name="refundStatus">Status of the refund. Can be INITIALIZED, SUCCESS, CANCEL, PENDING or FAILED..</param>
