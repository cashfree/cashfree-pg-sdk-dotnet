...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class LinkNotifyEntity : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="">If \&quot;true\&quot;, Cashfree will send sms on customer_phone..</param>
        /// <param name="">If \&quot;true\&quot;, Cashfree will send email on customer_email..</param>
        public LinkNotifyEntity(bool?  = default(bool?), bool?  = default(bool?))
        {
            this.send_sms = ;
            this.send_email = ;
        }
