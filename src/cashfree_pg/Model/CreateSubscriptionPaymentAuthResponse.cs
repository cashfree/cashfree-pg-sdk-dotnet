...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSubscriptionPaymentAuthResponse")]
    public class CreateSubscriptionPaymentAuthResponse : IEquatable<CreateSubscriptionPaymentAuthResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionPaymentAuthResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateSubscriptionPaymentAuthResponse);
        }

        /// <summary>
        /// Returns true if CreateSubscriptionPaymentAuthResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSubscriptionPaymentAuthResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSubscriptionPaymentAuthResponse input)
        {
            if (input == null)
            {
                return false;
