...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class SubscriptionPaymentEntityFailureDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionPaymentEntityFailureDetails" /> class.
        /// </summary>
        /// <param name="">Failure reason of the payment if the payment_status is failed..</param>
        public SubscriptionPaymentEntityFailureDetails(string?  = default(string?))
        {
            this.failure_reason = ;
        }
