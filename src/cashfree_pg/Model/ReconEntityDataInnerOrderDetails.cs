...
namespace cashfree_pg.Model
{
    ...
    public class ReconEntityDataInnerOrderDetails : IValidatableObject
    {
        ...
        public ReconEntityDataInnerOrderDetails(string? orderId = default(string?), decimal? orderAmount = default(decimal?), string? orderCurrency = default(string?), Object? orderTags = default(Object?))
        {
