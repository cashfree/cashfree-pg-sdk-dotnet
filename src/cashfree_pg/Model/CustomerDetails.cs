...
namespace cashfree_pg.Model
{
    ...
    public class CustomerDetails : IValidatableObject
    {
        ...
        /// <param name="customerPhone">Customer phone number. To accommodate international phone numbers, ensure the number is prefixed with a &#39;+&#39; to override the 10-digit limitation. (required).</param>
        /// <param name="customerName">Name of the customer..</param>
        /// <param name="customerBankAccountNumber">Customer&#39;s bank account number. This field is required only if you want to perform a bank account check (TPV)..</param>
        /// <param name="customerBankIfsc">Customer&#39;s bank IFSC. Required if you want to do a bank account check (TPV)..</param>
        /// <param name="customerBankCode">Customer&#39;s bank code. Required for net banking payments, if you want to do a bank account check (TPV)..</param>
        /// <param name="customerUid">Customer&#39;s identifier at Cashfree. You will get this when you create/get customer..</param>
