...
# **PGCreateOffer**
> OfferEntity PGCreateOffer (string xApiVersion, CreateOfferRequest createOfferRequest, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
<a id="pgfetchoffer"></a>
# **PGFetchOffer**
> OfferEntity PGFetchOffer (string xApiVersion, string offerId, string? xRequestId = null, Guid? xIdempotencyKey = null)
