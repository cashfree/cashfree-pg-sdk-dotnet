...
> VendorDocumentDownloadResponse PGESDownloadVendorsDocs (string docType, string vendorId, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
namespace Example
{
    public class PGESDownloadVendorsDocsExample
    {
        public static void Main()
        {
            ...
            {
                // Download Vendor Documents
                VendorDocumentDownloadResponse result = cashfree.PGESDownloadVendorsDocs(docType, vendorId, xRequestId, xIdempotencyKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
