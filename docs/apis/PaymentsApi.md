...
# **PGAuthorizeOrder**
> PaymentEntity PGAuthorizeOrder (string orderId, AuthorizeOrderRequest authorizeOrderRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> OrderAuthenticateEntity PGOrderAuthenticatePayment (string cfPaymentId, OrderAuthenticatePaymentRequest orderAuthenticatePaymentRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
# **PGOrderFetchPayment**
> PaymentEntity PGOrderFetchPayment (string orderId, string cfPaymentId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;PaymentEntity&gt; PGOrderFetchPayments (string orderId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
<a id="pgpayorder"></a>
# **PGPayOrder**
> PayOrderEntity PGPayOrder (PayOrderRequest payOrderRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null, string xClientDevice = null, string xClientOs = null, string xClientRenderingType = null, string xClientBrowser = null)
...
> PaymentEntity PGPayOrderAuthorizeOnly (PayOrderAuthorizeOnlyRequest payOrderAuthorizeOnlyRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
