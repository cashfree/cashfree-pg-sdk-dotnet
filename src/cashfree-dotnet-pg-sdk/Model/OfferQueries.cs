...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class OfferQueries : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OfferQueries" /> class.
        /// </summary>
        /// <param name="">OrderId of the order. Either of &#x60;order_id&#x60; or &#x60;order_amount&#x60; is mandatory..</param>
        /// <param name="">Amount of the order. OrderId of the order. Either of &#x60;order_id&#x60; or &#x60;order_amount&#x60; is mandatory..</param>
        public OfferQueries(string?  = default(string?), decimal?  = default(decimal?))
        {
            this.order_id = ;
            this.amount = ;
        }
