...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class EligibilityMethodItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EligibilityMethodItem" /> class.
        /// </summary>
        /// <param name="">Indicates whether the payment method is eligible..</param>
        /// <param name="">Type of entity (e.g., \&quot;payment_methods\&quot;)..</param>
        /// <param name="">Payment method (e.g., enach, pnach, upi, card)..</param>
        /// <param name="">.</param>
        public EligibilityMethodItem(bool?  = default(bool?), string?  = default(string?), string?  = default(string?), EligibilityMethodItemEntityDetails?  = default(EligibilityMethodItemEntityDetails?))
        {
            this.eligibility = ;
            this.entity_type = ;
            this.entity_value = ;
