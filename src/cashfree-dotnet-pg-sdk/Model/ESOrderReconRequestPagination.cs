...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class ESOrderReconRequestPagination : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="">.</param>
        /// <param name="">Set the minimum/maximum limit for number of filtered data. Min value - 10, Max value - 100..</param>
        public ESOrderReconRequestPagination(string?  = default(string?), int?  = default(int?))
        {
            this.cursor = ;
            this.limit = ;
        }
