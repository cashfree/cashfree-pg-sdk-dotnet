...
namespace cashfree_pg.Model
{
    ...
    public class SettlementWebhook : IEquatable<SettlementWebhook>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SettlementWebhook);
        }

        /// <summary>
        /// Returns true if SettlementWebhook instances are equal
        /// </summary>
        /// <param name="input">Instance of SettlementWebhook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SettlementWebhook input)
        {
            if (input == null)
            {
                return false;
