...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class SettlementFetchReconRequestFilters : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SettlementFetchReconRequestFilters" /> class.
        /// </summary>
        /// <param name="">List of settlement IDs for which you want the settlement reconciliation details..</param>
        /// <param name="">List of settlement UTRs for which you want the settlement reconciliation details..</param>
        /// <param name="">Specify the start date from when you want the settlement reconciliation details..</param>
        /// <param name="">Specify the end date till when you want the settlement reconciliation details..</param>
        public SettlementFetchReconRequestFilters(List<int>?  = default(List<int>?), List<string>?  = default(List<string>?), string?  = default(string?), string?  = default(string?))
        {
            this.cf_settlement_ids = ;
            this.settlement_utrs = ;
            this.start_date = ;
            this.end_date = ;
        }
