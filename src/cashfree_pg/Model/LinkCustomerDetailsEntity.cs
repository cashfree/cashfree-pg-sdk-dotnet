...
namespace cashfree_pg.Model
{
    ...
    public class LinkCustomerDetailsEntity : IValidatableObject
    {
        ...
        /// <param name="customerBankAcoountHolderName">Customer Bank Account Holder Name..</param>
        public LinkCustomerDetailsEntity(string customerPhone = default(string), string? customerEmail = default(string?), string? customerName = default(string?), string? customerBankAccountNumber = default(string?), string? customerBankIfsc = default(string?), CustomerBankCodeEnum? customerBankCode = default(CustomerBankCodeEnum?), string? customerBankAcoountHolderName = default(string?))
        {
            ...
            this.customer_bank_acoount_holder_name = customerBankAcoountHolderName;
        }
