...
namespace cashfree_pg.Model
{
    ...
    public class PaymentMethodCardInPaymentsEntityCard : IEquatable<PaymentMethodCardInPaymentsEntityCard>, IValidatableObject
    {
        /// <summary>
        ...
        public PaymentMethodCardInPaymentsEntityCard(string? channel = default(string?), string? cardNumber = default(string?), string? cardNetwork = default(string?), string? cardType = default(string?), string? cardCountry = default(string?), string? cardBankName = default(string?), string? cardNetworkReferenceId = default(string?), string? instrumentId = default(string?))
        {
        ...
        {
            return this.Equals(input as PaymentMethodCardInPaymentsEntityCard);
        }

        /// <summary>
        /// Returns true if PaymentMethodCardInPaymentsEntityCard instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentMethodCardInPaymentsEntityCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodCardInPaymentsEntityCard input)
        {
            if (input == null)
            {
                return false;
