...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ENACH")]
    public class ENACH : IEquatable<ENACH>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ENACH" /> class.
        /// </summary>
        ...
        public ENACH(string? channel = default(string?), string? authMode = default(string?), string? accountHolderName = default(string?), string? accountNumber = default(string?), string? accountBankCode = default(string?), string? accountType = default(string?), string? accountIfsc = default(string?))
        {
        ...
        {
            return this.Equals(input as ENACH);
        }

        /// <summary>
        /// Returns true if ENACH instances are equal
        /// </summary>
        /// <param name="input">Instance of ENACH to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ENACH input)
        {
            if (input == null)
            {
                return false;
