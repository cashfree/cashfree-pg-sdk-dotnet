...
> DeletedInstrumentEntity PGCustomerDeleteInstrument (string customerId, string instrumentId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> InstrumentEntity PGCustomerFetchInstrument (string customerId, string instrumentId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;InstrumentEntityForAllSavedCard&gt; PGCustomerFetchInstruments (string customerId, string instrumentType, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> CryptogramEntity PGCustomerInstrumentsFetchCryptogram (string customerId, string instrumentId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
