...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UploadVendorDocumentsResponse")]
    public class UploadVendorDocumentsResponse : IEquatable<UploadVendorDocumentsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadVendorDocumentsResponse" /> class.
        /// </summary>
        ...
        public UploadVendorDocumentsResponse(string? vendorId = default(string?), string? docType = default(string?), string? docValue = default(string?), string? status = default(string?), string? remarks = default(string?))
        {
        ...
        {
            return this.Equals(input as UploadVendorDocumentsResponse);
        }

        /// <summary>
        /// Returns true if UploadVendorDocumentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UploadVendorDocumentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UploadVendorDocumentsResponse input)
        {
            if (input == null)
            {
                return false;
