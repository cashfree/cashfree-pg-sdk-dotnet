...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VendorEntity_related_docs_inner")]
    public class VendorEntityRelatedDocsInner : IEquatable<VendorEntityRelatedDocsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VendorEntityRelatedDocsInner" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as VendorEntityRelatedDocsInner);
        }

        /// <summary>
        /// Returns true if VendorEntityRelatedDocsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of VendorEntityRelatedDocsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VendorEntityRelatedDocsInner input)
        {
            if (input == null)
            {
                return false;
