...
namespace cashfree_pg.Model
{
    ...
    public class ManageSubscriptionRequestActionDetails : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="nextScheduledTime">Next scheduled time for the action. Required for ACTIVATE action.   Please note that only the date component is considered. Any time value provided will be ignored..</param>
