...
namespace cashfree_pg.Model
{
    ...
    public class SubscriptionCustomerDetails : IValidatableObject
    {
        ...
        /// <param name="customerBankAccountHolderName">Bank holder name of the customer. Account holder name is mandatory for TPV transaction. Max character allowed is 40..</param>
        /// <param name="customerBankAccountNumber">Bank account number of the customer. Conditional Parameter. Max character allowed is 35..</param>
        /// <param name="customerBankIfsc">IFSC code of the customer. For a TPV transaction, send at least one out of &#x60;customer_bank_code&#x60; or &#x60;customer_bank_ifsc&#x60;..</param>
        /// <param name="customerBankCode">Bank code of the customer. Refer to the list of Live Banks in API E-Mandate [here](https://www.npci.org.in/product/nach/all-members). For a TPV transactions, include at least one of &#x60;customer_bank_code&#x60; or &#x60;customer_bank_ifsc&#x60;..</param>
        /// <param name="customerBankAccountType">Bank account type of the customer..</param>
        public SubscriptionCustomerDetails(string? customerName = default(string?), string customerEmail = default(string), string customerPhone = default(string), string? customerBankAccountHolderName = default(string?), string? customerBankAccountNumber = default(string?), string? customerBankIfsc = default(string?), string? customerBankCode = default(string?), CustomerBankAccountTypeEnum? customerBankAccountType = default(CustomerBankAccountTypeEnum?))
        {
