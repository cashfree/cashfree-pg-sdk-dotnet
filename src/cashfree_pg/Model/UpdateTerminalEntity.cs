...
namespace cashfree_pg.Model
{
    ...
    public class UpdateTerminalEntity : IEquatable<UpdateTerminalEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTerminalEntity" /> class.
        /// </summary>
        ...
        public UpdateTerminalEntity(string? addedOn = default(string?), int? cfTerminalId = default(int?), string? lastUpdatedOn = default(string?), string? terminalAddress = default(string?), string? terminalEmail = default(string?), string? terminalType = default(string?), string? teminalId = default(string?), string? terminalName = default(string?), string? terminalNote = default(string?), string? terminalPhoneNo = default(string?), string? terminalStatus = default(string?), TerminalEntityTerminalMeta? terminalMeta = default(TerminalEntityTerminalMeta?))
        {
        ...
        /// </summary>
        /// <param name="input">Instance of UpdateTerminalEntity to be compared</param>
        /// <returns>Boolean</returns>
