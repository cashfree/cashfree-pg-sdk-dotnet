...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentMethodInPaymentsEntityPaymentMethodJsonConverter))]
    [DataContract(Name = "PaymentMethodInPaymentsEntity_payment_method")]
    public class PaymentMethodInPaymentsEntityPaymentMethod : AbstractOpenAPISchema, IEquatable<PaymentMethodInPaymentsEntityPaymentMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodInPaymentsEntityPaymentMethod" /> class
        ...
        public PaymentMethodInPaymentsEntityPaymentMethod(PaymentMethodCardInPaymentsEntity actualInstance)
        {
        ...
        public PaymentMethodInPaymentsEntityPaymentMethod(PaymentMethodNetBankingInPaymentsEntity actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public PaymentMethodInPaymentsEntityPaymentMethod(PaymentMethodUPIInPaymentsEntity actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public PaymentMethodInPaymentsEntityPaymentMethod(PaymentMethodAppInPaymentsEntity actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public PaymentMethodInPaymentsEntityPaymentMethod(PaymentMethodCardlessEMIInPaymentsEntity actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public PaymentMethodInPaymentsEntityPaymentMethod(PaymentMethodPaylaterInPaymentsEntity actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public PaymentMethodInPaymentsEntityPaymentMethod(PaymentMethodCardEMIInPaymentsEntity actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentMethodInPaymentsEntityPaymentMethod {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, PaymentMethodInPaymentsEntityPaymentMethod.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of PaymentMethodInPaymentsEntityPaymentMethod
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of PaymentMethodInPaymentsEntityPaymentMethod</returns>
        public static PaymentMethodInPaymentsEntityPaymentMethod FromJson(string jsonString)
        {
            PaymentMethodInPaymentsEntityPaymentMethod newPaymentMethodInPaymentsEntityPaymentMethod = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newPaymentMethodInPaymentsEntityPaymentMethod;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodAppInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.SerializerSettings));
                }
                else
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodAppInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodCardEMIInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.SerializerSettings));
                }
                else
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodCardEMIInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodCardInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.SerializerSettings));
                }
                else
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodCardInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodCardlessEMIInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.SerializerSettings));
                }
                else
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodCardlessEMIInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodNetBankingInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.SerializerSettings));
                }
                else
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodNetBankingInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodPaylaterInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.SerializerSettings));
                }
                else
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodPaylaterInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodUPIInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.SerializerSettings));
                }
                else
                {
                    newPaymentMethodInPaymentsEntityPaymentMethod = new PaymentMethodInPaymentsEntityPaymentMethod(JsonConvert.DeserializeObject<PaymentMethodUPIInPaymentsEntity>(jsonString, PaymentMethodInPaymentsEntityPaymentMethod.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as PaymentMethodInPaymentsEntityPaymentMethod);
        }

        /// <summary>
        /// Returns true if PaymentMethodInPaymentsEntityPaymentMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentMethodInPaymentsEntityPaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodInPaymentsEntityPaymentMethod input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for PaymentMethodInPaymentsEntityPaymentMethod
    /// </summary>
    public class PaymentMethodInPaymentsEntityPaymentMethodJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(PaymentMethodInPaymentsEntityPaymentMethod).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return PaymentMethodInPaymentsEntityPaymentMethod.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
