...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class FetchReconRequestPagination : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="FetchReconRequestPagination" /> class.
        /// </summary>
        /// <param name="">Number of settlements you want to fetch in the next iteration. Maximum limit is 1000, default value is 10. (required).</param>
        /// <param name="">Specifies from where the next set of settlement details should be fetched..</param>
        public FetchReconRequestPagination(int  = default(int), string?  = default(string?))
        {
            this.limit = ;
            this.cursor = ;
        }
