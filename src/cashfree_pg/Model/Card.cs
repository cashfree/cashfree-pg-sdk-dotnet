...
namespace cashfree_pg.Model
{
    ...
    public class Card : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Card" /> class.
        /// </summary>
        /// <param name="channel">The channel for card payments can be \&quot;link\&quot; or \&quot;post\&quot;. Use \&quot;post\&quot; to request [Native OTP](https://www.cashfree.com/docs/payments/features/native-otp) authentication, where the merchant must render the Native OTP UI to collect the OTP. Otherwise, use link for the redirection flow. (required).</param>
        /// <param name="cardNumber">Customer’s card number for plain card transactions, or token number for external token transactions, or Alt ID number for external Alt ID transactions..</param>
        /// <param name="cardHolderName">Name on the customer’s card. Optional for external token or external Alt ID transactions..</param>
        /// <param name="cardExpiryMm">Card expiry month for plain card transactions, or token expiry month for external token transactions, or Alt ID expiry month for external Alt ID transactions..</param>
        /// <param name="cardExpiryYy">Card expiry year for plain card transactions, or token expiry year for external token transactions and Alt ID expiry year for external Alt ID transactions..</param>
        /// <param name="cardCvv">CVV mentioned on the card. Mandatory for plain card and external Alt ID transactions; optional for saved card transactions..</param>
        /// <param name="instrumentId">Instrument ID of the saved card, as received in response from [Fetch All Saved Card Instrument API](https://www.cashfree.com/docs/api-reference/payments/latest/token-vault/get-all). Required only when making payments using cards saved with Cashfree..</param>
        /// <param name="cryptogram">Cryptogram received from the card network. Required only for external token or external Alt ID transactions; provided by the merchant’s token requestor..</param>
        /// <param name="tokenRequestorId">Token Requestor ID (TRID) issued by the respective card network. Required only for external token transactions; provided by the merchant’s token requestor..</param>
        /// <param name="tokenReferenceId">Token Reference ID, required only for external Alt ID transactions for Diners; provided by the merchant’s token requestor..</param>
        /// <param name="tokenType">Token type enum. Mandatory only for external Alt ID transactions..</param>
        /// <param name="cardDisplay">Last 4 digits of original card number, required only for external token or external Alt ID transactions, used for bookkeeping purposes..</param>
        ...
        /// <param name="zipCode">Pin Code/Zip Code..</param>
        /// <param name="country">Country Name..</param>
        /// <param name="countryCode">Country Code. Should be in ISO 2 format (ie. US for United States)..</param>
        /// <param name="state">State Name..</param>
        /// <param name="stateCode">State Code. Should be in ISO 2 format (ie. FL for Florida)..</param>
        /// <param name="emiTenure">EMI tenure selected by the user..</param>
        /// <param name="par">Par received from network..</param>
        public Card(ChannelEnum channel = default(ChannelEnum), string? cardNumber = default(string?), string? cardHolderName = default(string?), string? cardExpiryMm = default(string?), string? cardExpiryYy = default(string?), string? cardCvv = default(string?), string? instrumentId = default(string?), string? cryptogram = default(string?), string? tokenRequestorId = default(string?), string? tokenReferenceId = default(string?), TokenTypeEnum? tokenType = default(TokenTypeEnum?), string? cardDisplay = default(string?), CardBankNameEnum? cardBankName = default(CardBankNameEnum?), string? addressLineOne = default(string?), string? addressLineTwo = default(string?), string? city = default(string?), string? zipCode = default(string?), string? country = default(string?), string? countryCode = default(string?), string? state = default(string?), string? stateCode = default(string?), int? emiTenure = default(int?), string? par = default(string?))
        {
