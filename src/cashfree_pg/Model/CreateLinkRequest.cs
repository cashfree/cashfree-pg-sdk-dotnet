...
namespace cashfree_pg.Model
{
    ...
    public class CreateLinkRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CreateLinkRequest" /> class.
        /// </summary>
        /// <param name="linkId">Unique Identifier (provided by merchant) for the Link. Alphanumeric and only - and _ allowed (50 character limit). Use this for other link-related APIs..</param>
        /// <param name="linkAmount">Amount to be collected using this link. Provide upto two decimals for paise. (required).</param>
        /// <param name="linkCurrency">Currency for the payment link. Default is INR. Submit [Support Form](https://merchant.cashfree.com/auth/login) to enable new currencies. (required).</param>
        /// <param name="linkPurpose">A brief description for which payment must be collected. This is shown to the customer..</param>
        ...
        public CreateLinkRequest(string? linkId = default(string?), double linkAmount = default(double), string linkCurrency = default(string), string? linkPurpose = default(string?), LinkCustomerDetailsEntity customerDetails = default(LinkCustomerDetailsEntity), bool? linkPartialPayments = default(bool?), double? linkMinimumPartialAmount = default(double?), string? linkExpiryTime = default(string?), LinkNotifyEntity? linkNotify = default(LinkNotifyEntity?), bool? linkAutoReminders = default(bool?), Dictionary<string, string>? linkNotes = default(Dictionary<string, string>?), LinkMetaResponseEntity? linkMeta = default(LinkMetaResponseEntity?), List<VendorSplit>? orderSplits = default(List<VendorSplit>?), bool? enableInvoice = default(bool?), Subscription? subscription = default(Subscription?))
        {
            ...
            this.enable_invoice = enableInvoice;
        ...
        public static Boolean checkPresenceOfKey(string jsonString) {
            ...
            if (deserializedJsonString.ContainsKey("link_id")) {
                return true;
            }
            return false;
        }
