...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentModeDetails : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public PaymentModeDetails(string?  = default(string?), string?  = default(string?), bool?  = default(bool?), decimal?  = default(decimal?))
        {
            this.nick = ;
            this.display = ;
            this.eligibility = ;
