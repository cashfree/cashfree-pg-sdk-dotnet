...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CustomerDetails : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CustomerDetails" /> class.
        /// </summary>
        /// <param name="">A unique identifier for the customer. Use alphanumeric values only. (required).</param>
        /// <param name="">Customer email address..</param>
        /// <param name="">Customer phone number. To accommodate international phone numbers, ensure the number is prefixed with a &#39;+&#39; to override the 10-digit limitation. (required).</param>
        /// <param name="">Name of the customer..</param>
        /// <param name="">Customer&#39;s bank account number. This field is required only if you want to perform a bank account check (TPV)..</param>
        /// <param name="">Customer&#39;s bank IFSC. Required if you want to do a bank account check (TPV)..</param>
        /// <param name="">Customer&#39;s bank code. Required for net banking payments, if you want to do a bank account check (TPV)..</param>
        /// <param name="">Customer&#39;s identifier at Cashfree. You will get this when you create/get customer..</param>
        public CustomerDetails(string  = default(string), string?  = default(string?), string  = default(string), string?  = default(string?), string?  = default(string?), string?  = default(string?), decimal?  = default(decimal?), string?  = default(string?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CustomerDetails and cannot be null");
            }
            this.customer_id = ;
            // to ensure "" is required (not null)
            if ( == null)
        ...
        /// </summary>
        /// <value>Customer phone number. To accommodate international phone numbers, ensure the number is prefixed with a &#39;+&#39; to override the 10-digit limitation.</value>
        ...
        /// </summary>
        /// <value>Customer&#39;s bank account number. This field is required only if you want to perform a bank account check (TPV).</value>
        ...
        /// </summary>
        /// <value>Customer&#39;s bank IFSC. Required if you want to do a bank account check (TPV).</value>
        ...
        /// </summary>
        /// <value>Customer&#39;s bank code. Required for net banking payments, if you want to do a bank account check (TPV).</value>
        ...
        /// </summary>
        /// <value>Customer&#39;s identifier at Cashfree. You will get this when you create/get customer.</value>
