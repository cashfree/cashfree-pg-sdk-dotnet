...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class OrderDeliveryStatus : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="">Delivery status of order..</param>
        /// <param name="">Reason of provided order delivery status. This is optional field..</param>
        public OrderDeliveryStatus(StatusEnum?  = default(StatusEnum?), string?  = default(string?))
        {
            this.status = ;
            this.reason = ;
        }
