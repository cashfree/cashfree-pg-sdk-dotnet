# cashfree-dotnet-pg-sdk.Api.SettlementsApi
...
> SettlementEntity PGOrderFetchSettlement (string orderId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
