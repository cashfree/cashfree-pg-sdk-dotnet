...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class UploadTerminalDocs : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UploadTerminalDocs" /> class.
        /// </summary>
        /// <param name="">Mention the document type you are uploading. Possible values - ADDRESSPROOF, PHOTOGRAPH. (required).</param>
        /// <param name="">Enter the display name of the uploaded file. (required).</param>
        /// <param name="">Select the document that should be uploaded or provide the path of that file. You cannot upload a file that is more than 2MB in size. (required).</param>
        public UploadTerminalDocs(string  = default(string), string  = default(string), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UploadTerminalDocs and cannot be null");
            }
            this.doc_type = ;
            // to ensure "" is required (not null)
            if ( == null)
