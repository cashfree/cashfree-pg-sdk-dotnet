...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CustomerDetailsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerDetailsResponse" /> class.
        /// </summary>
        /// <param name="">A unique identifier for the customer. Use alphanumeric values only..</param>
        /// <param name="">Customer email address..</param>
        /// <param name="">Customer phone number..</param>
        /// <param name="">Name of the customer..</param>
        /// <param name="">Customer bank account. Required if you want to do a bank account check (TPV)..</param>
        /// <param name="">Customer bank IFSC. Required if you want to do a bank account check (TPV)..</param>
        /// <param name="">Customer bank code. Required for net banking payments, if you want to do a bank account check (TPV)..</param>
        /// <param name="">Customer identifier at Cashfree. You will get this when you create/get customer..</param>
        public CustomerDetailsResponse(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), decimal?  = default(decimal?), string?  = default(string?))
        {
            this.customer_id = ;
            this.customer_email = ;
            this.customer_phone = ;
