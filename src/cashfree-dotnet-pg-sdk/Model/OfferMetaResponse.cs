...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class OfferMetaResponse : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="">Unique identifier for the Offer..</param>
        /// <param name="">Description for the Offer..</param>
        /// <param name="">Expiry Time for the Offer..</param>
        /// <param name="">Start Time for the Offer..</param>
        /// <param name="">Title for the Offer..</param>
        public OfferMetaResponse(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.offer_code = ;
