...
namespace cashfree_pg.Model
{
    ...
    public class ESOrderReconResponse : IEquatable<ESOrderReconResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ESOrderReconResponse);
        }

        /// <summary>
        /// Returns true if ESOrderReconResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ESOrderReconResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ESOrderReconResponse input)
        {
            if (input == null)
            {
                return false;
