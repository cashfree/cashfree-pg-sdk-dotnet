...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentMethodCardEMIInPaymentsEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodCardEMIInPaymentsEntity" /> class.
        /// </summary>
        /// <param name="">.</param>
        public PaymentMethodCardEMIInPaymentsEntity(PaymentMethodCardEMIInPaymentsEntityEmi?  = default(PaymentMethodCardEMIInPaymentsEntityEmi?))
        {
            this.emi = ;
        }
