...
namespace cashfreepg.Model
{
    ...
    /// CFLinkOrders
    /// </summary>
    [DataContract(Name = "CFLinkOrders")]
    public partial class CFLinkOrders : IEquatable<CFLinkOrders>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CFLinkOrders" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CFLinkOrders);
        }

        /// <summary>
        /// Returns true if CFLinkOrders instances are equal
        /// </summary>
        /// <param name="input">Instance of CFLinkOrders to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CFLinkOrders? input)
        {
            if (input == null)
            {
                return false;
