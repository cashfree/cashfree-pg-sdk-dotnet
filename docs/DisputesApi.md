# cashfree-dotnet-pg-sdk.Api.DisputesApi
...
<a id="pgacceptdisputebyid"></a>
# **PGAcceptDisputeByID**
> DisputesEntityMerchantAccepted PGAcceptDisputeByID (string xApiVersion, int disputeId, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
namespace Example
{
    public class PGAcceptDisputeByIDExample
    {
        public static void Main()
        {
            ...
            {
                // Accept Dispute by Dispute ID
                DisputesEntityMerchantAccepted result = cashfree.PGAcceptDisputeByID(xApiVersion, disputeId, xRequestId, xIdempotencyKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DisputesApi.PGAcceptDisputeByID: " + e.Message);
...
<a id="pgfetchdisputebyid"></a>
# **PGFetchDisputeByID**
> DisputesEntity PGFetchDisputeByID (string xApiVersion, int disputeId, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
namespace Example
{
    public class PGFetchDisputeByIDExample
    {
        public static void Main()
        {
            // Configuration
            ...
            {
                // Get Disputes by Dispute ID
                DisputesEntity result = cashfree.PGFetchDisputeByID(xApiVersion, disputeId, xRequestId, xIdempotencyKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DisputesApi.PGFetchDisputeByID: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
<a id="pgfetchorderdisputes"></a>
# **PGFetchOrderDisputes**
> List&lt;DisputesEntity&gt; PGFetchOrderDisputes (string xApiVersion, string orderId, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
namespace Example
{
    public class PGFetchOrderDisputesExample
    {
        public static void Main()
        {
            // Configuration
            ...
            {
                // Get Disputes by Order ID
                List<DisputesEntity> result = cashfree.PGFetchOrderDisputes(xApiVersion, orderId, xRequestId, xIdempotencyKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DisputesApi.PGFetchOrderDisputes: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
<a id="pgfetchpaymentdisputes"></a>
# **PGFetchPaymentDisputes**
> List&lt;DisputesEntity&gt; PGFetchPaymentDisputes (string xApiVersion, int cfPaymentId, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
namespace Example
{
    public class PGFetchPaymentDisputesExample
    {
        public static void Main()
        {
            // Configuration
            ...
            {
                // Get Disputes by Payment ID
                List<DisputesEntity> result = cashfree.PGFetchPaymentDisputes(xApiVersion, cfPaymentId, xRequestId, xIdempotencyKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DisputesApi.PGFetchPaymentDisputes: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
<a id="pguploaddisputesdocuments"></a>
# **PGUploadDisputesDocuments**
> List&lt;DisputesEntity&gt; PGUploadDisputesDocuments (string xApiVersion, int disputeId, string file, string docType, string? xRequestId = null, Guid? xIdempotencyKey = null, string? note = null)
...
namespace Example
{
    public class PGUploadDisputesDocumentsExample
    {
        public static void Main()
        {
            // Configuration
            ...
            {
                // Submit Evidence to contest the Dispute by Dispute ID
                List<DisputesEntity> result = cashfree.PGUploadDisputesDocuments(xApiVersion, disputeId, file, docType, xRequestId, xIdempotencyKey, note);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DisputesApi.PGUploadDisputesDocuments: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
