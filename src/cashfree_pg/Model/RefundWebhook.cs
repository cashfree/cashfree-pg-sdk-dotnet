...
namespace cashfree_pg.Model
{
    ...
    public class RefundWebhook : IEquatable<RefundWebhook>, IValidatableObject
    {
        ...
        public RefundWebhook(PaymentWebhookDataEntity1 data = default(PaymentWebhookDataEntity1), string eventTime = default(string), string type = default(string))
        {
            this.data = data;
        ...
        public PaymentWebhookDataEntity1 data { get; set; }
