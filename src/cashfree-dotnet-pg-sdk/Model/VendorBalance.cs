...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class VendorBalance : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public VendorBalance(decimal?  = default(decimal?), string?  = default(string?), decimal?  = default(decimal?), decimal?  = default(decimal?))
        {
            this.merchant_id = ;
            this.vendor_id = ;
            this.merchant_unsettled = ;
            this.vendor_unsettled = ;
        }
