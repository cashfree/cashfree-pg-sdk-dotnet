...
namespace cashfree_pg.Model
{
    ...
    public class CreateSubscriptionPaymentRequestPnachPnach : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="accountBankCode">Account bank code. Consists of the first four alphabetic characters of the IFSC..</param>
        /// <param name="accountHolderName">Account holder name..</param>
        /// <param name="accountIfsc">Account IFSC. Complete 11-character alphanumeric code..</param>
