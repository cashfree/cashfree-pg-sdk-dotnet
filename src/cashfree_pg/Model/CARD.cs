...
namespace cashfree_pg.Model
{
    ...
    public class CARD : IEquatable<CARD>, IValidatableObject
    {
        ...
        public CARD(string? channel = default(string?), string? cardNumber = default(string?), string? cardHolderName = default(string?), string? cardExpiryMm = default(string?), string? cardExpiryYy = default(string?), string? cardCvv = default(string?), string? cardNetwork = default(string?), string? cardType = default(string?))
        {
