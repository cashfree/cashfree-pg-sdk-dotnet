...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WHcustomer_details")]
    public class WHcustomerDetails : IEquatable<WHcustomerDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WHcustomerDetails" /> class.
        /// </summary>
        /// <param name="customerName">customerName.</param>
        /// <param name="customerId">customerId.</param>
        /// <param name="customerEmail">customerEmail.</param>
        /// <param name="customerPhone">customerPhone.</param>
        public WHcustomerDetails(string customerName = default(string), string customerId = default(string), string customerEmail = default(string), string customerPhone = default(string))
        {
        ...
        {
            return this.Equals(input as WHcustomerDetails);
        }

        /// <summary>
        /// Returns true if WHcustomerDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of WHcustomerDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WHcustomerDetails input)
        {
            if (input == null)
            {
                return false;
