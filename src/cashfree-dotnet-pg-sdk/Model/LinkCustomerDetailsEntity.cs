...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class LinkCustomerDetailsEntity : IValidatableObject
    {
        /// <summary>
        /// Customer Bank Code.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="LinkCustomerDetailsEntity" /> class.
        /// </summary>
        /// <param name="">Customer phone number. (required).</param>
        /// <param name="">Customer email address..</param>
        /// <param name="">Customer name..</param>
        /// <param name="">Customer Bank Account Number..</param>
        /// <param name="">Customer Bank Ifsc..</param>
        /// <param name="">Customer Bank Code..</param>
        /// <param name="">Customer Bank Account Holder Name..</param>
        public LinkCustomerDetailsEntity(string  = default(string), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), CustomerBankCodeEnum?  = default(CustomerBankCodeEnum?), string?  = default(string?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for LinkCustomerDetailsEntity and cannot be null");
            }
            this.customer_phone = ;
            this.customer_email = ;
            this.customer_name = ;
            ...
            this.customer_bank_acoount_holder_name = ;
        }
        ...
        /// </summary>
        /// <value>Customer Bank Account Holder Name.</value>
        [DataMember(Name = "customer_bank_acoount_holder_name", EmitDefaultValue = false)]
        public string? customer_bank_acoount_holder_name { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  customer_bank_acoount_holder_name: ").Append(customer_bank_acoount_holder_name).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
