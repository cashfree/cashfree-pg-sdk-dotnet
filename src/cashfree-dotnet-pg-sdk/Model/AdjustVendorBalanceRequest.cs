...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class AdjustVendorBalanceRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="AdjustVendorBalanceRequest" /> class.
        /// </summary>
        /// <param name="">Mention to whom you want to transfer the on demand balance. Possible values - MERCHANT, VENDOR. (required).</param>
        /// <param name="">Mention the type of transfer. Possible values: ON_DEMAND. (required).</param>
        /// <param name="">Mention the on demand transfer amount. (required).</param>
        /// <param name="">Mention remarks if any for the on demand transfer..</param>
        /// <param name="">Provide additional data fields using tags..</param>
        public AdjustVendorBalanceRequest(string  = default(string), string  = default(string), decimal  = default(decimal), string?  = default(string?), Object?  = default(Object?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AdjustVendorBalanceRequest and cannot be null");
            }
            this.transfer_from = ;
            // to ensure "" is required (not null)
            if ( == null)
