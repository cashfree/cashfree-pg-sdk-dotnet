...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CreateSubscriptionRequestAuthorizationDetails : IValidatableObject
    {
        ...
        /// <param name="">Payment methods for the subscription. enach, pnach, upi, card are possible values..</param>
        public CreateSubscriptionRequestAuthorizationDetails(decimal?  = default(decimal?), bool?  = default(bool?), List<string>?  = default(List<string>?))
        {
