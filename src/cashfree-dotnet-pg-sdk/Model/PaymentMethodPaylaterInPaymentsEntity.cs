...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentMethodPaylaterInPaymentsEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodPaylaterInPaymentsEntity" /> class.
        /// </summary>
        /// <param name="">.</param>
        public PaymentMethodPaylaterInPaymentsEntity(PaymentMethodAppInPaymentsEntityApp?  = default(PaymentMethodAppInPaymentsEntityApp?))
        {
            this.paylater = ;
        }
