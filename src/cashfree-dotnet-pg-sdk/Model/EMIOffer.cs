...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class EMIOffer : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="EMIOffer" /> class.
        /// </summary>
        /// <param name="">Type of emi offer. Possible values are &#x60;credit_card_emi&#x60;, &#x60;debit_card_emi&#x60;, &#x60;cardless_emi&#x60;. (required).</param>
        /// <param name="">Bank Name. (required).</param>
        /// <param name=""> (required).</param>
        public EMIOffer(string  = default(string), string  = default(string), List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EMIOffer and cannot be null");
            }
            this.type = ;
            // to ensure "" is required (not null)
            if ( == null)
