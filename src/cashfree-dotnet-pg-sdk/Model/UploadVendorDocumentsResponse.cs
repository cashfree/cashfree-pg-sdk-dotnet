...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class UploadVendorDocumentsResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public UploadVendorDocumentsResponse(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.vendor_id = ;
            this.doc_type = ;
            this.doc_value = ;
