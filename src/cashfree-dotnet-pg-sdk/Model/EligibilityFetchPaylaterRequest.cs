...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class EligibilityFetchPaylaterRequest : IValidatableObject
    {
        ...
        public EligibilityFetchPaylaterRequest(CardlessEMIQueries  = default(CardlessEMIQueries))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EligibilityFetchPaylaterRequest and cannot be null");
            }
            this.queries = ;
        }
