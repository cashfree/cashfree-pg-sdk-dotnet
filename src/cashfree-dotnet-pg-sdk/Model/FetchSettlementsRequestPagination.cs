...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class FetchSettlementsRequestPagination : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="FetchSettlementsRequestPagination" /> class.
        /// </summary>
        /// <param name="">The number of settlements you want to fetch. Maximum limit is 1000, default value is 10. (required).</param>
        /// <param name="">Specifies from where the next set of settlement details should be fetched..</param>
        public FetchSettlementsRequestPagination(int  = default(int), string?  = default(string?))
        {
            this.limit = ;
            this.cursor = ;
        }
