...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReconEntity_data_inner")]
    public class ReconEntityDataInner : IEquatable<ReconEntityDataInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReconEntityDataInner" /> class.
        /// </summary>
        /// <param name="eventId">Unique ID associated with the event..</param>
        /// <param name="eventType">The event type can be SETTLEMENT, PAYMENT, REFUND, REFUND_REVERSAL, DISPUTE, DISPUTE_REVERSAL, CHARGEBACK, CHARGEBACK_REVERSAL, OTHER_ADJUSTMENT..</param>
        /// <param name="eventSettlementAmount">Amount that is part of the settlement corresponding to the event..</param>
        /// <param name="eventAmount">Amount of the event. Example, refund amount, dispute amount, payment amount, etc..</param>
        ...
        /// <param name="closedInFavorOf">Specifies whether the dispute was closed in favor of the merchant or customer. /n Possible values - Merchant, Customer.</param>
        ...
        /// <param name="refundArn">The bank reference number for the refund..</param>
        /// <param name="refundNote">A refund note for your reference..</param>
        /// <param name="refundId">An unique ID to associate the refund with..</param>
        /// <param name="adjustmentRemarks">Other adjustment remarks..</param>
        /// <param name="adjustment">Amount that is adjusted from the settlement amount because of any credit/debit event such as refund, refund_reverse etc..</param>
        /// <param name="serviceTax">Service tax applicable on the settlement amount..</param>
        /// <param name="serviceCharge">Service charge applicable on the settlement amount..</param>
        /// <param name="amountSettled">Net amount that is settled after considering the adjustments, settlement charge and tax..</param>
        /// <param name="paymentFrom">The start time of the time range of the payments considered for the settlement..</param>
        /// <param name="paymentTill">The end time of time range of the payments considered for the settlement..</param>
        /// <param name="reason">Reason for settlement failure..</param>
        /// <param name="settlementInitiatedOn">Date and time when the settlement was initiated..</param>
        /// <param name="settlementType">Type of settlement. Possible values - Standard, Instant, On demand..</param>
        ...
        public ReconEntityDataInner(string? eventId = default(string?), string? eventType = default(string?), decimal? eventSettlementAmount = default(decimal?), decimal? eventAmount = default(decimal?), string? saleType = default(string?), string? eventStatus = default(string?), string? entity = default(string?), string? eventTime = default(string?), string? eventCurrency = default(string?), string? orderId = default(string?), decimal? orderAmount = default(decimal?), string? customerPhone = default(string?), string? customerEmail = default(string?), string? customerName = default(string?), decimal? paymentAmount = default(decimal?), string? paymentUtr = default(string?), string? paymentTime = default(string?), decimal? paymentServiceCharge = default(decimal?), decimal? paymentServiceTax = default(decimal?), string? cfPaymentId = default(string?), string? cfSettlementId = default(string?), string? settlementDate = default(string?), string? settlementUtr = default(string?), decimal? splitServiceCharge = default(decimal?), decimal? splitServiceTax = default(decimal?), decimal? vendorCommission = default(decimal?), string? closedInFavorOf = default(string?), string? disputeResolvedOn = default(string?), string? disputeCategory = default(string?), string? disputeNote = default(string?), string? refundProcessedAt = default(string?), string? refundArn = default(string?), string? refundNote = default(string?), string? refundId = default(string?), string? adjustmentRemarks = default(string?), decimal? adjustment = default(decimal?), decimal? serviceTax = default(decimal?), decimal? serviceCharge = default(decimal?), decimal? amountSettled = default(decimal?), string? paymentFrom = default(string?), string? paymentTill = default(string?), string? reason = default(string?), string? settlementInitiatedOn = default(string?), string? settlementType = default(string?), decimal? settlementCharge = default(decimal?), decimal? settlementTax = default(decimal?), string? remarks = default(string?), decimal? forexConversionHandlingCharge = default(decimal?), decimal? forexConversionHandlingTax = default(decimal?), string? chargesCurrency = default(string?))
        {
            ...
            this.amount_settled = amountSettled;
        ...
        /// </summary>
        /// <value>The event type can be SETTLEMENT, PAYMENT, REFUND, REFUND_REVERSAL, DISPUTE, DISPUTE_REVERSAL, CHARGEBACK, CHARGEBACK_REVERSAL, OTHER_ADJUSTMENT.</value>
        ...
        /// </summary>
        /// <value>Amount of the event. Example, refund amount, dispute amount, payment amount, etc.</value>
        ...
        /// </summary>
        /// <value>Cashfree forex conversion charges for processing transaction</value>
        ...
        /// </summary>
        /// <value>Cashfree forex conversion tax for processing transaction</value>
        ...
        /// </summary>
        /// <value>Cashfree charges currency for a event type</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  amount_settled: ").Append(amount_settled).Append("\n");
        ...
        {
            return this.Equals(input as ReconEntityDataInner);
        }

        /// <summary>
        /// Returns true if ReconEntityDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ReconEntityDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReconEntityDataInner input)
        {
            if (input == null)
            {
                return false;
