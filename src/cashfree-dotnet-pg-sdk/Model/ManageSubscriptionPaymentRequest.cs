...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class ManageSubscriptionPaymentRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ManageSubscriptionPaymentRequest" /> class.
        /// </summary>
        /// <param name="">The unique ID which was used to create subscription. (required).</param>
        /// <param name="">The unique ID which was used to create payment. (required).</param>
        /// <param name="">Action to be performed on the payment. Possible values - CANCEL, RETRY. (required).</param>
        /// <param name="">.</param>
        public ManageSubscriptionPaymentRequest(string  = default(string), string  = default(string), string  = default(string), ManageSubscriptionPaymentRequestActionDetails?  = default(ManageSubscriptionPaymentRequestActionDetails?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for ManageSubscriptionPaymentRequest and cannot be null");
            }
