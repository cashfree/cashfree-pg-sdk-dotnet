...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class TerminalTransactionEntity : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public TerminalTransactionEntity(long?  = default(long?), int?  = default(int?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.cf_payment_id = ;
            this.payment_amount = ;
            this.payment_method = ;
