...
namespace cashfree_pg.Model
{
    ...
    public class OfferTncResponse : IEquatable<OfferTncResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="offerTncType">TnC Type for the Offer. It can be either &#x60;text&#x60; or &#x60;link&#x60;.</param>
        /// <param name="offerTncValue">TnC for the Offer..</param>
        public OfferTncResponse(OfferTncTypeEnum? offerTncType = default(OfferTncTypeEnum?), string? offerTncValue = default(string?))
        {
        ...
        {
            return this.Equals(input as OfferTncResponse);
        }

        /// <summary>
        /// Returns true if OfferTncResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OfferTncResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OfferTncResponse input)
        {
            if (input == null)
            {
                return false;
