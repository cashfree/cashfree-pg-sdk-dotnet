...
namespace cashfree_pg.Model
{
    ...
    public class LinkPlanEntity : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="planId">Unique ID to identify the plan. Only alpha-numerics, dot, hyphen and underscore allowed..</param>
        /// <param name="planName">Name of the plan..</param>
        /// <param name="planType">Type of the plan. Possible values - PERIODIC, ON_DEMAND..</param>
        ...
        public LinkPlanEntity(string? planId = default(string?), string? planName = default(string?), string? planType = default(string?), string? planCurrency = default(string?), decimal? planAmount = default(decimal?), decimal? planMaxAmount = default(decimal?), int? planMaxCycles = default(int?), int? planIntervals = default(int?), string? planIntervalType = default(string?), string? planNote = default(string?))
        {
            this.plan_id = planId;
