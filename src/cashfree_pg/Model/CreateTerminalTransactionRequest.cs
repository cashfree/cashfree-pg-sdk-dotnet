...
namespace cashfree_pg.Model
{
    ...
    public class CreateTerminalTransactionRequest : IValidatableObject
    {
        ...
        /// <param name="paymentMethod">mention the payment method used for the transaction. possible values - QR_CODE, LINK..</param>
        ...
        public CreateTerminalTransactionRequest(string cfOrderId = default(string), long? cfTerminalId = default(long?), string? paymentMethod = default(string?), string? terminalPhoneNo = default(string?), bool? addInvoice = default(bool?))
        {
