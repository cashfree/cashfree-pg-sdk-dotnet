...
namespace cashfree_pg.Model
{
    ...
    public class UpdateSoundboxVpaRequest : IValidatableObject
    {
        ...
        public UpdateSoundboxVpaRequest(string vpa = default(string), long cfTerminalId = default(long), string? merchantName = default(string?), string? language = default(string?))
        {
