...
namespace cashfreepg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LinkCancelledResponse")]
    public partial class CFLinkCancelledResponse : IEquatable<CFLinkCancelledResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CFLinkCancelledResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LinkCancelledResponse {\n");
        ...
        {
            return this.Equals(input as CFLinkCancelledResponse);
        }

        /// <summary>
        /// Returns true if LinkCancelledResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkCancelledResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CFLinkCancelledResponse? input)
        {
            if (input == null)
            {
                return false;
