...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentMethodCardEMIInPaymentsEntityEmiEmiDetails : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public PaymentMethodCardEMIInPaymentsEntityEmiEmiDetails(decimal?  = default(decimal?), decimal?  = default(decimal?), decimal?  = default(decimal?))
        {
            this.emi_amount = ;
            this.emi_tenure = ;
            this.emi_interest = ;
