...
namespace cashfree_pg.Model
{
    ...
    public class TerminalPaymentEntity : IEquatable<TerminalPaymentEntity>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TerminalPaymentEntity);
        }

        /// <summary>
        /// Returns true if TerminalPaymentEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of TerminalPaymentEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TerminalPaymentEntity input)
        {
            if (input == null)
            {
                return false;
