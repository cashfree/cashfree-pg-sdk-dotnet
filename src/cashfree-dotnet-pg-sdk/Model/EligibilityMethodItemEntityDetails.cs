...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class EligibilityMethodItemEntityDetails : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="">List of account types associated with the payment method. (e.g. SAVINGS or CURRENT)..</param>
        /// <param name="">List of the most frequently used banks..</param>
        /// <param name="">Details about all banks associated with the payment method..</param>
        /// <param name="">List of supported VPA handles..</param>
        /// <param name="">List of allowed card types. (e.g. DEBIT_CARD, CREDIT_CARD)..</param>
        public EligibilityMethodItemEntityDetails(List<string>?  = default(List<string>?), List<SubscriptionBankDetails>?  = default(List<SubscriptionBankDetails>?), List<SubscriptionBankDetails>?  = default(List<SubscriptionBankDetails>?), List<EligibilityMethodItemEntityDetailsAvailableHandlesInner>?  = default(List<EligibilityMethodItemEntityDetailsAvailableHandlesInner>?), List<string>?  = default(List<string>?))
        {
            this.account_types = ;
            this.frequent_bank_details = ;
            this.all_bank_details = ;
            this.available_handles = ;
