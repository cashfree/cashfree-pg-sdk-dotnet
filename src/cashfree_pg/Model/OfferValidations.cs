...
namespace cashfree_pg.Model
{
    ...
    public class OfferValidations : IValidatableObject
    {
        ...
        public OfferValidations(decimal? minAmount = default(decimal?), decimal maxAllowed = default(decimal), OfferValidationsResponsePaymentMethod paymentMethod = default(OfferValidationsResponsePaymentMethod))
        {
