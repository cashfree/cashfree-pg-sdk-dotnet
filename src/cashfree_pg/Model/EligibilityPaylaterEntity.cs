...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EligibilityPaylaterEntity")]
    public class EligibilityPaylaterEntity : IEquatable<EligibilityPaylaterEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EligibilityPaylaterEntity" /> class.
        /// </summary>
        ...
        public EligibilityPaylaterEntity(bool eligibility = default(bool), string entityType = default(string), string entityValue = default(string), PaylaterEntity entityDetails = default(PaylaterEntity))
        {
        ...
        public PaylaterEntity entity_details { get; set; }
        ...
        {
            return this.Equals(input as EligibilityPaylaterEntity);
        }

        /// <summary>
        /// Returns true if EligibilityPaylaterEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of EligibilityPaylaterEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EligibilityPaylaterEntity input)
        {
            if (input == null)
            {
                return false;
