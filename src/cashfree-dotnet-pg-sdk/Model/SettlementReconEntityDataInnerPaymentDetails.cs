...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class SettlementReconEntityDataInnerPaymentDetails : IValidatableObject
    {
        /// <summary>
        ...
        public SettlementReconEntityDataInnerPaymentDetails(decimal?  = default(decimal?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), decimal?  = default(decimal?), decimal?  = default(decimal?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.payment_amount = ;
