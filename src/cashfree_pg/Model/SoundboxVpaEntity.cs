...
namespace cashfree_pg.Model
{
    ...
    public class SoundboxVpaEntity : IValidatableObject
    {
        ...
        public SoundboxVpaEntity(string? vpa = default(string?), long? cfTerminalId = default(long?), string? deviceSerialNo = default(string?), string? merchantName = default(string?), string? language = default(string?))
        {
            this.vpa = vpa;
