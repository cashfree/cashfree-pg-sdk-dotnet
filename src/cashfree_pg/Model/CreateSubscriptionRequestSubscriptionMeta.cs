...
namespace cashfree_pg.Model
{
    ...
    public class CreateSubscriptionRequestSubscriptionMeta : IValidatableObject
    {
        ...
        /// <param name="sessionIdExpiry">Expiry date for the subscription session..</param>
        public CreateSubscriptionRequestSubscriptionMeta(string? returnUrl = default(string?), List<string>? notificationChannel = default(List<string>?), string? sessionIdExpiry = default(string?))
        {
            this.return_url = returnUrl;
            this.notification_channel = notificationChannel;
            this.session_id_expiry = sessionIdExpiry;
        }
