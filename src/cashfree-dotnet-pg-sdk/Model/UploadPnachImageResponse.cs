...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class UploadPnachImageResponse : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="">The payment_id against which the pnach image is uploaded..</param>
        /// <param name="">Authorization status of the subscription..</param>
        /// <param name="">Action performed on the file..</param>
        /// <param name="">Message of the API..</param>
        public UploadPnachImageResponse(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.payment_id = ;
