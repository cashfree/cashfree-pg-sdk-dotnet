...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CreatePlanRequest : IValidatableObject
    {
        ...
        /// <param name="">Currency of the plan. For plans in non-INR currency, please refer to [supported currencies](https://www.cashfree.com/docs/payments/international-payments/ipg/currencies-supported#full-currency-list)..</param>
        /// <param name="">Recurring amount for the plan. Required for PERIODIC plan_type..</param>
        /// <param name="">Maximum amount for the plan. (required).</param>
        /// <param name="">Maximum number of payment cycles for the plan..</param>
        /// <param name="">Number of billing cycles between charges. For instance, if set to 2 and the interval type is &#39;week&#39;, the service will be billed every 2 weeks. Similarly, if set to 3 and the interval type is &#39;month&#39;, the service will be billed every 3 months. Required for PERIODIC plan_type..</param>
        /// <param name="">Interval type for the plan. Possible values - DAY, WEEK, MONTH, YEAR..</param>
        /// <param name="">Note for the plan..</param>
        public CreatePlanRequest(string  = default(string), string  = default(string), string  = default(string), string?  = default(string?), decimal?  = default(decimal?), decimal  = default(decimal), int?  = default(int?), int?  = default(int?), string?  = default(string?), string?  = default(string?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CreatePlanRequest and cannot be null");
            }
            this.plan_id = ;
            // to ensure "" is required (not null)
            if ( == null)
        ...
        /// </summary>
        /// <value>Currency of the plan. For plans in non-INR currency, please refer to [supported currencies](https://www.cashfree.com/docs/payments/international-payments/ipg/currencies-supported#full-currency-list).</value>
