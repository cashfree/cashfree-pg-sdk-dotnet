# cashfree-dotnet-pg-sdk.Api.RefundsApi
...
<a id="pgorderupdaterefund"></a>
# **PGOrderUpdateRefund**
> RefundEntity PGOrderUpdateRefund (string xApiVersion, string orderId, string refundId, OrderUpdateRefundRequest orderUpdateRefundRequest, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
namespace Example
{
    public class PGOrderUpdateRefundExample
    {
        public static void Main()
        {
            // Configuration
            ...
            var xApiVersion = 2026-01-01;  // string | API version to be used. Format is in YYYY-MM-DD. (default to "2026-01-01")
            var orderId = your-order-id;  // string | The ID which uniquely identifies your order.
            var refundId = some-refund-id;  // string | Refund Id of the refund you want to update.
            var orderUpdateRefundRequest = new OrderUpdateRefundRequest(); // OrderUpdateRefundRequest | Request Body to Update Refunds.
            var xRequestId = 4dfb9780-46fe-11ee-be56-0242ac120002;  // string? | Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional) 
            var xIdempotencyKey = 47bf8872-46fe-11ee-be56-0242ac120002;  // Guid? | An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional) 
            ...
            {
                // Update Refund
                RefundEntity result = cashfree.PGOrderUpdateRefund(xApiVersion, orderId, refundId, orderUpdateRefundRequest, xRequestId, xIdempotencyKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling RefundsApi.PGOrderUpdateRefund: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
