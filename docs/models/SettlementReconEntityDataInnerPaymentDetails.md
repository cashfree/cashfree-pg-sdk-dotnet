...
------------ | ------------- | ------------- | -------------
**PaymentAmount** | **decimal** | Payment amount captured. | [optional] 
...
**PaymentServiceCharge** | **decimal** | Service charge applicable for the payment. | [optional] 
**PaymentServiceTax** | **decimal** | Service tax applicable on the payment. | [optional] 
