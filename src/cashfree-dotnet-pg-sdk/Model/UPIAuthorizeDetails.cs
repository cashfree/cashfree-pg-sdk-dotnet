...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class UPIAuthorizeDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UPIAuthorizeDetails" /> class.
        /// </summary>
        /// <param name="">Time by which this authorization should be approved by the customer..</param>
        /// <param name="">This is the time when the UPI one time mandate will start..</param>
        /// <param name="">This is the time when the UPI mandate will be over. If the mandate has not been executed by this time, the funds will be returned back to the customer after this time..</param>
        public UPIAuthorizeDetails(string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.approve_by = ;
            this.start_time = ;
            this.end_time = ;
