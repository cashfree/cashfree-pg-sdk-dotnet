...
# **SposCreateTerminal**
> TerminalEntity SposCreateTerminal (CreateTerminalRequest createTerminalRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> TerminalTransactionEntity SposCreateTerminalTransaction (CreateTerminalTransactionRequest createTerminalTransactionRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;SoundboxVpaEntity&gt; SposDemapSoundboxVpa (DemapSoundboxVpaRequest demapSoundboxVpaRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
# **SposFetchTerminal**
> TerminalEntity SposFetchTerminal (string terminalPhoneNo, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;FetchTerminalQRCodesEntity&gt; SposFetchTerminalQRCodes (string terminalPhoneNo, int cfTerminalId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;SoundboxVpaEntity&gt; SposFetchTerminalSoundboxVpa (string deviceSerialNo, int cfTerminalId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> TerminalPaymentEntity SposFetchTerminalTransaction (string utr, int cfTerminalId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> SoundboxVpaEntity SposOnboardSoundboxVpa (OnboardSoundboxVpaRequest onboardSoundboxVpaRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> SoundboxVpaEntity SposUpdateSoundboxVpa (int cfTerminalId, UpdateSoundboxVpaRequest updateSoundboxVpaRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
# **SposUpdateTerminal**
> List&lt;UpdateTerminalEntity&gt; SposUpdateTerminal (int cfTerminalId, UpdateTerminalRequest updateTerminalRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;UpdateTerminalEntity&gt; SposUpdateTerminalStatus (int cfTerminalId, UpdateTerminalStatusRequest updateTerminalStatusRequest, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;UploadTerminalDocsEntity&gt; SposUploadTerminalDocs (int cfTerminalId, UploadTerminalDocs uploadTerminalDocs, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
