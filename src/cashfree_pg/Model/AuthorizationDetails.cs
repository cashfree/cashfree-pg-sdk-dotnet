...
namespace cashfree_pg.Model
{
    ...
    public class AuthorizationDetails : IValidatableObject
    {
        ...
        /// <param name="authorizationTime">Authorization time. Cashfree stores timestamps in IST..</param>
        ...
        /// <param name="paymentGroup">Payment group used for the authorization..</param>
        /// <param name="paymentMethod">paymentMethod.</param>
        public AuthorizationDetails(decimal? authorizationAmount = default(decimal?), bool? authorizationAmountRefund = default(bool?), string? authorizationReference = default(string?), string? authorizationTime = default(string?), string? authorizationStatus = default(string?), string? paymentId = default(string?), string? paymentGroup = default(string?), AuthorizationDetailsPaymentMethod? paymentMethod = default(AuthorizationDetailsPaymentMethod?))
        {
