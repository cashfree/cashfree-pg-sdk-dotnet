...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class EligibilityPaylaterEntity : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public EligibilityPaylaterEntity(bool?  = default(bool?), string?  = default(string?), string?  = default(string?), PaylaterEntity?  = default(PaylaterEntity?))
        {
            this.eligibility = ;
            this.entity_type = ;
            this.entity_value = ;
