...
namespace cashfree_pg.Model
{
    ...
    public class Card : IEquatable<Card>, IValidatableObject
    {
        ...
        public Card(ChannelEnum channel = default(ChannelEnum), string? cardNumber = default(string?), string? cardHolderName = default(string?), string? cardExpiryMm = default(string?), string? cardExpiryYy = default(string?), string? cardCvv = default(string?), string? instrumentId = default(string?), string? cryptogram = default(string?), string? tokenRequestorId = default(string?), string? tokenReferenceId = default(string?), TokenTypeEnum? tokenType = default(TokenTypeEnum?), string? cardDisplay = default(string?), string? cardAlias = default(string?), CardBankNameEnum? cardBankName = default(CardBankNameEnum?), string? addressLineOne = default(string?), string? addressLineTwo = default(string?), string? city = default(string?), string? zipCode = default(string?), string? country = default(string?), string? countryCode = default(string?), string? state = default(string?), string? stateCode = default(string?), int? emiTenure = default(int?))
        {
