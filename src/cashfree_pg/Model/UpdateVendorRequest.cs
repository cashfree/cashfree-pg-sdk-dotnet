...
namespace cashfree_pg.Model
{
    ...
    public class UpdateVendorRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="status">Specify the status of vendor that should be updated. Possible value: ACTIVE..</param>
        /// <param name="name">Specify the name of the vendor to be updated. Name should not have any special character except . / - &amp;..</param>
        /// <param name="email">Specify the vendor email ID that should be updated. String in email ID format (Ex:johndoe_1@cashfree.com) should contain @ and dot (.)..</param>
        /// <param name="phone">Specify the beneficiaries phone number to be updated. Phone number registered in India (only digits, 8 - 12 characters after excluding +91)..</param>
        ...
        /// <param name="kycDetails">Specify the kyc details that should be updated..</param>
