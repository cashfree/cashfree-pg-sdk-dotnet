...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CreateSubscriptionPaymentRequestPaymentMethod : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionPaymentRequestPaymentMethod" /> class
        /// with the <see cref="CreateSubscriptionPaymentRequestUpi" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of CreateSubscriptionPaymentRequestUpi.</param>
        public CreateSubscriptionPaymentRequestPaymentMethod(CreateSubscriptionPaymentRequestUpi actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionPaymentRequestPaymentMethod" /> class
        /// with the <see cref="CreateSubscriptionPaymentRequestEnach" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of CreateSubscriptionPaymentRequestEnach.</param>
        public CreateSubscriptionPaymentRequestPaymentMethod(CreateSubscriptionPaymentRequestEnach actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(CreateSubscriptionPaymentRequestEnach))
                {
                    this._actualInstance = value;
                }
                ...
                else if (value.GetType() == typeof(CreateSubscriptionPaymentRequestUpi))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: CreateSubscriptionPaymentRequestCard, CreateSubscriptionPaymentRequestEnach, CreateSubscriptionPaymentRequestPnach, CreateSubscriptionPaymentRequestUpi");
                }
            }
        }
        ...
        /// </summary>
        /// <returns>An instance of CreateSubscriptionPaymentRequestUpi</returns>
        public CreateSubscriptionPaymentRequestUpi GetCreateSubscriptionPaymentRequestUpi()
        {
            return (CreateSubscriptionPaymentRequestUpi)this.ActualInstance;
        }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of CreateSubscriptionPaymentRequestEnach</returns>
        public CreateSubscriptionPaymentRequestEnach GetCreateSubscriptionPaymentRequestEnach()
        {
            return (CreateSubscriptionPaymentRequestEnach)this.ActualInstance;
        }
        ...
        public static CreateSubscriptionPaymentRequestPaymentMethod FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(CreateSubscriptionPaymentRequestEnach).GetProperty("AdditionalProperties") == null)
                {
                    if(CreateSubscriptionPaymentRequestEnach.checkPresenceOfKey(jsonString)) {
                        dynamic data = JsonConvert.DeserializeObject<CreateSubscriptionPaymentRequestEnach>(jsonString, CreateSubscriptionPaymentRequestPaymentMethod.AdditionalPropertiesSerializerSettings);
                        newCreateSubscriptionPaymentRequestPaymentMethod = new CreateSubscriptionPaymentRequestPaymentMethod(data);
                        return newCreateSubscriptionPaymentRequestPaymentMethod;
                    }
                }
                ...
                matchedTypes.Add("CreateSubscriptionPaymentRequestEnach");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into CreateSubscriptionPaymentRequestEnach: {1}", jsonString, exception.ToString()));
            }
            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(CreateSubscriptionPaymentRequestUpi).GetProperty("AdditionalProperties") == null)
                {
                    if(CreateSubscriptionPaymentRequestUpi.checkPresenceOfKey(jsonString)) {
                        dynamic data = JsonConvert.DeserializeObject<CreateSubscriptionPaymentRequestUpi>(jsonString, CreateSubscriptionPaymentRequestPaymentMethod.AdditionalPropertiesSerializerSettings);
                        newCreateSubscriptionPaymentRequestPaymentMethod = new CreateSubscriptionPaymentRequestPaymentMethod(data);
                        return newCreateSubscriptionPaymentRequestPaymentMethod;
                    }
                }
                ...
                matchedTypes.Add("CreateSubscriptionPaymentRequestUpi");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into CreateSubscriptionPaymentRequestUpi: {1}", jsonString, exception.ToString()));
            }
