...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class OfferTnc : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="OfferTnc" /> class.
        /// </summary>
        /// <param name="">TnC Type for the Offer. It can be either &#x60;text&#x60; or &#x60;link&#x60;. (required).</param>
        /// <param name="">TnC for the Offer. (required).</param>
        public OfferTnc(OfferTncTypeEnum  = default(OfferTncTypeEnum), string  = default(string))
        {
            this.offer_tnc_type = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for OfferTnc and cannot be null");
            }
