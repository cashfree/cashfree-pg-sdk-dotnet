...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class CreateCustomerRequest : IValidatableObject
    {
        ...
        public CreateCustomerRequest(string  = default(string), string?  = default(string?), string?  = default(string?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CreateCustomerRequest and cannot be null");
            }
            this.customer_phone = ;
            this.customer_email = ;
            this.customer_name = ;
