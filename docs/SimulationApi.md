...
> SettlementSimulationResponse PGFetchSettlementSimulation (string xApiVersion, string simulationId, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
namespace Example
{
    public class PGFetchSettlementSimulationExample
    {
        public static void Main()
        {
            ...
            {
                // Fetch Settlement Simulation
                SettlementSimulationResponse result = cashfree.PGFetchSettlementSimulation(xApiVersion, simulationId, xRequestId, xIdempotencyKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling SimulationApi.PGFetchSettlementSimulation: " + e.Message);
...
namespace Example
{
    public class PGSimulatePaymentExample
    {
        public static void Main()
        {
            ...
            var xApiVersion = 2026-01-01;  // string | API version to be used. Format is in YYYY-MM-DD. (default to "2026-01-01")
            var simulateRequest = new SimulateRequest(); // SimulateRequest | Request body for simulation.
            var xRequestId = 4dfb9780-46fe-11ee-be56-0242ac120002;  // string? | Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional) 
            var xIdempotencyKey = 47bf8872-46fe-11ee-be56-0242ac120002;  // Guid? | An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional) 
...
> SettlementSimulationResponse PGSimulateSettlement (string xApiVersion, SimulateSettlementRequest simulateSettlementRequest, string? xRequestId = null, Guid? xIdempotencyKey = null)
...
namespace Example
{
    public class PGSimulateSettlementExample
    {
        public static void Main()
        {
            // Configuration
            ...
            var xApiVersion = 2026-01-01;  // string | API version to be used. Format is in YYYY-MM-DD. (default to "2026-01-01")
            var simulateSettlementRequest = new SimulateSettlementRequest(); // SimulateSettlementRequest | The request body for simulating a settlement.
            var xRequestId = 4dfb9780-46fe-11ee-be56-0242ac120002;  // string? | Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional) 
            var xIdempotencyKey = 47bf8872-46fe-11ee-be56-0242ac120002;  // Guid? | An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional) 
            ...
            {
                // Simulate Settlement Payment
                SettlementSimulationResponse result = cashfree.PGSimulateSettlement(xApiVersion, simulateSettlementRequest, xRequestId, xIdempotencyKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling SimulationApi.PGSimulateSettlement: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
