...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class UpdateTerminalRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UpdateTerminalRequest" /> class.
        /// </summary>
        /// <param name="">Mention the updated email ID of the terminal..</param>
        /// <param name="">Terminal phone number to be updated..</param>
        /// <param name="">.</param>
        /// <param name="">Mention the terminal type to be updated. Possible values - AGENT, STOREFRONT. (required).</param>
        public UpdateTerminalRequest(string?  = default(string?), string?  = default(string?), UpdateTerminalRequestTerminalMeta?  = default(UpdateTerminalRequestTerminalMeta?), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UpdateTerminalRequest and cannot be null");
            }
            this.terminal_type = ;
            this.terminal_email = ;
