...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DisputeEvidence_inner")]
    public class DisputeEvidenceInner : IEquatable<DisputeEvidenceInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DisputeEvidenceInner" /> class.
        /// </summary>
        /// <param name="documentId">documentId.</param>
        /// <param name="documentName">documentName.</param>
        /// <param name="documentType">documentType.</param>
        public DisputeEvidenceInner(int? documentId = default(int?), string? documentName = default(string?), string? documentType = default(string?))
        {
        ...
        {
            return this.Equals(input as DisputeEvidenceInner);
        }

        /// <summary>
        /// Returns true if DisputeEvidenceInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DisputeEvidenceInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisputeEvidenceInner input)
        {
            if (input == null)
            {
                return false;
