...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class ProductConditions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductConditions" /> class.
        /// </summary>
        /// <param name="">The Action key in the conditions array specifies whether a condition should \&quot;ALLOW\&quot; or \&quot;DENY\&quot; the specified rule or feature..</param>
        /// <param name="">Specify what you&#39;re trying to configure, such as \&quot;features.\&quot;..</param>
        /// <param name="">Define the values you need to set within the conditions in this array, such as \&quot;checkoutCollectAddress\&quot;, \&quot;checkoutAuthenticate\&quot;..</param>
        public ProductConditions(string?  = default(string?), string?  = default(string?), List<string>?  = default(List<string>?))
        {
            this.action = ;
            this.key = ;
            this.values = ;
