...
# **PGAcceptDisputeByID**
> DisputesEntityMerchantAccepted PGAcceptDisputeByID (int disputeId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
# **PGFetchDisputeByID**
> DisputesEntity PGFetchDisputeByID (int disputeId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;DisputesEntity&gt; PGFetchOrderDisputes (string orderId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;DisputesEntity&gt; PGFetchPaymentDisputes (int cfPaymentId, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null)
...
> List&lt;DisputesEntity&gt; PGUploadDisputesDocuments (int disputeId, string file, string docType, string xApiVersion, string xRequestId = null, Guid xIdempotencyKey = null, string note = null)
