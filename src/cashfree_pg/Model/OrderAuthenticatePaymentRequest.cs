...
namespace cashfree_pg.Model
{
    ...
    public class OrderAuthenticatePaymentRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="OrderAuthenticatePaymentRequest" /> class.
        /// </summary>
        /// <param name="otp">OTP collected from the customer. Mandatory only when action is SUBMIT_OTP..</param>
        /// <param name="action">Action intended for this request - can be SUBMIT_OTP or RESEND_OTP. (required).</param>
