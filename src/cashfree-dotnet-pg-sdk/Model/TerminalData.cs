...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class TerminalData : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public TerminalData(string?  = default(string?), int?  = default(int?), string?  = default(string?), string?  = default(string?))
        {
            this.agent_mobile_number = ;
            this.cf_terminal_id = ;
            this.merchant_terminal_id = ;
            this.terminal_type = ;
        }
