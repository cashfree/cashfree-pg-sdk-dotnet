...
namespace cashfree_pg.Model
{
    ...
    public class OnboardSoundboxVpaRequest : IValidatableObject
    {
        ...
        /// <param name="deviceSerialNo">Device Serial No of soundbox..</param>
        ...
        public OnboardSoundboxVpaRequest(string vpa = default(string), long cfTerminalId = default(long), string? deviceSerialNo = default(string?), string? merchantName = default(string?), string? language = default(string?))
        {
