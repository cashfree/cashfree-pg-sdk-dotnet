...
> AdjustVendorBalanceResponse PGESCreateOnDemandTransfer (string xApiVersion, string vendorId, AdjustVendorBalanceRequest? adjustVendorBalanceRequest = null)
...
namespace Example
{
    public class PGESCreateOnDemandTransferExample
    {
        public static void Main()
        {
            ...
            {
                // Create On Demand Transfer
                AdjustVendorBalanceResponse result = cashfree.PGESCreateOnDemandTransfer(xApiVersion, vendorId, adjustVendorBalanceRequest);
...
# **PGESCreateVendors**
> CreateVendorResponse PGESCreateVendors (string xApiVersion, CreateVendorRequest? createVendorRequest = null)
...
namespace Example
{
    public class PGESCreateVendorsExample
    {
        public static void Main()
        {
            ...
            {
                // Create vendor
                CreateVendorResponse result = cashfree.PGESCreateVendors(xApiVersion, createVendorRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> VendorDocumentDownloadResponse PGESDownloadVendorsDocs (string docType, string vendorId)
...
namespace Example
{
    public class PGESDownloadVendorsDocsExample
    {
        public static void Main()
        {
            ...
            {
                // Download Vendor Documents
                VendorDocumentDownloadResponse result = cashfree.PGESDownloadVendorsDocs(docType, vendorId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **PGESFetchVendors**
> VendorEntity PGESFetchVendors (string xApiVersion, string vendorId)
...
namespace Example
{
    public class PGESFetchVendorsExample
    {
        public static void Main()
        {
            ...
            {
                // Get Vendor All Details
                VendorEntity result = cashfree.PGESFetchVendors(xApiVersion, vendorId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> VendorBalance PGESGetVendorBalance (string xApiVersion, string vendorId)
...
namespace Example
{
    public class PGESGetVendorBalanceExample
    {
        public static void Main()
        {
            ...
            {
                // Get On Demand Balance
                VendorBalance result = cashfree.PGESGetVendorBalance(xApiVersion, vendorId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> VendorBalanceTransferCharges PGESGetVendorBalanceTransferCharges (string xApiVersion, decimal amount, string rateType)
...
namespace Example
{
    public class PGESGetVendorBalanceTransferChargesExample
    {
        public static void Main()
        {
            ...
            {
                // Get Vendor Balance Transfer Charges
                VendorBalanceTransferCharges result = cashfree.PGESGetVendorBalanceTransferCharges(xApiVersion, amount, rateType);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **PGESGetVendorsDocs**
> VendorDocumentsResponse PGESGetVendorsDocs (string xApiVersion, string vendorId)
...
namespace Example
{
    public class PGESGetVendorsDocsExample
    {
        public static void Main()
        {
            ...
            {
                // Get Vendor All Documents Status
                VendorDocumentsResponse result = cashfree.PGESGetVendorsDocs(xApiVersion, vendorId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **PGESOrderRecon**
> ESOrderReconResponse PGESOrderRecon (string xApiVersion, ESOrderReconRequest? eSOrderReconRequest = null)
...
namespace Example
{
    public class PGESOrderReconExample
    {
        public static void Main()
        {
            ...
            {
                // Get Split and Settlement Details by OrderID v2.0
                ESOrderReconResponse result = cashfree.PGESOrderRecon(xApiVersion, eSOrderReconRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **PGESUpdateVendors**
> UpdateVendorResponse PGESUpdateVendors (string xApiVersion, string vendorId, UpdateVendorRequest? updateVendorRequest = null)
...
namespace Example
{
    public class PGESUpdateVendorsExample
    {
        public static void Main()
        {
            ...
            {
                // Update vendor Details
                UpdateVendorResponse result = cashfree.PGESUpdateVendors(xApiVersion, vendorId, updateVendorRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> UploadVendorDocumentsResponse PGESUploadVendorsDocs (string xApiVersion, string vendorId, UploadVendorDocsRequest? uploadVendorDocsRequest = null)
...
namespace Example
{
    public class PGESUploadVendorsDocsExample
    {
        public static void Main()
        {
            ...
            var xApiVersion = 2023-08-01;  // string | API version to be used. Format is in YYYY-MM-DD (default to "2023-08-01")
            var vendorId = your-vendor-id;  // string | The id which uniquely identifies your vendor.
            var uploadVendorDocsRequest = new UploadVendorDocsRequest?(); // UploadVendorDocsRequest? | Upload Vendor Docs Request Body. (optional) 

            try
            {
                // Upload Vendor Docs
                UploadVendorDocumentsResponse result = cashfree.PGESUploadVendorsDocs(xApiVersion, vendorId, uploadVendorDocsRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> SplitAfterPaymentResponse PGOrderSplitAfterPayment (string xApiVersion, string orderId, SplitAfterPaymentRequest? splitAfterPaymentRequest = null)
...
namespace Example
{
    public class PGOrderSplitAfterPaymentExample
    {
        public static void Main()
        {
            ...
            {
                // Split After Payment
                SplitAfterPaymentResponse result = cashfree.PGOrderSplitAfterPayment(xApiVersion, orderId, splitAfterPaymentRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **PGOrderStaticSplit**
> StaticSplitResponse PGOrderStaticSplit (string xApiVersion, StaticSplitRequest? staticSplitRequest = null)
...
namespace Example
{
    public class PGOrderStaticSplitExample
    {
        public static void Main()
        {
            ...
            {
                // Create Static Split Configuration
                StaticSplitResponse result = cashfree.PGOrderStaticSplit(xApiVersion, staticSplitRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
