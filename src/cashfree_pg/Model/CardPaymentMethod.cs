...
namespace cashfree_pg.Model
{
    ...
    public class CardPaymentMethod : IEquatable<CardPaymentMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public CardPaymentMethod(Card card = default(Card))
        {
            // to ensure "card" is required (not null)
            if (card == null)
            {
                throw new ArgumentNullException("card is a required property for CardPaymentMethod and cannot be null");
            }
            this.card = card;
        }
