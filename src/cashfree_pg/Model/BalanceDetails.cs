...
namespace cashfree_pg.Model
{
    ...
    public class BalanceDetails : IEquatable<BalanceDetails>, IValidatableObject
    {
        /// <summary>
        ...
        public BalanceDetails(decimal merchantId = default(decimal), string vendorId = default(string), decimal merchantUnsettled = default(decimal), decimal vendorUnsettled = default(decimal))
        {
