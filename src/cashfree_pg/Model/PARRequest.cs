...
namespace cashfree_pg.Model
{
    ...
    public class PARRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="PARRequest" /> class.
        /// </summary>
        /// <param name="cardNumber">The card number, containing 15 to 19 numeric digits without spaces or special characters. (required).</param>
        /// <param name="cardCvv">The Card Verification Value (CVV), a 3-digit code for most cards (Visa, Mastercard) and a 4-digit code for American Express, used for transaction authentication. (required).</param>
        /// <param name="cardExpiryMm">The two-digit expiry month (01-12), indicating when the card will expire. (required).</param>
        /// <param name="cardExpiryYy">The two-digit expiry year, representing the last two digits of the card’s expiration year. (required).</param>
        /// <param name="cardType">Specifies the type of card, with the only accepted value being &#x60;PLAIN_CARD&#x60;..</param>
