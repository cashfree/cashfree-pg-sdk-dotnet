...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentMethodsQueries : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodsQueries" /> class.
        /// </summary>
        /// <param name="">Amount of the order..</param>
        /// <param name="">OrderId of the order. Either of &#x60;order_id&#x60; or &#x60;order_amount&#x60; is mandatory..</param>
        public PaymentMethodsQueries(decimal?  = default(decimal?), string?  = default(string?))
        {
            this.amount = ;
            this.order_id = ;
        }
