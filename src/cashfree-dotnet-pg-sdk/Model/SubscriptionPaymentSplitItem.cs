...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class SubscriptionPaymentSplitItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionPaymentSplitItem" /> class.
        /// </summary>
        /// <param name="">Vendor ID..</param>
        /// <param name="">Percentage of the payment to be split to vendor..</param>
        public SubscriptionPaymentSplitItem(string?  = default(string?), decimal?  = default(decimal?))
        {
            this.vendor_id = ;
            this.percentage = ;
        }
