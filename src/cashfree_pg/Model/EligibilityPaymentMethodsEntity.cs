...
namespace cashfree_pg.Model
{
    ...
    public class EligibilityPaymentMethodsEntity : IEquatable<EligibilityPaymentMethodsEntity>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EligibilityPaymentMethodsEntity);
        }

        /// <summary>
        /// Returns true if EligibilityPaymentMethodsEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of EligibilityPaymentMethodsEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EligibilityPaymentMethodsEntity input)
        {
            if (input == null)
            {
                return false;
