...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class ESOrderReconRequestFilters : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="">Specify the start data from which you want to get the recon data..</param>
        /// <param name="">Specify the end data till which you want to get the recon data..</param>
        /// <param name="">Please provide list of order ids for which you want to get the recon data..</param>
        public ESOrderReconRequestFilters(string?  = default(string?), string?  = default(string?), List<string>?  = default(List<string>?))
        {
            this.start_date = ;
            this.end_date = ;
            this.order_ids = ;
