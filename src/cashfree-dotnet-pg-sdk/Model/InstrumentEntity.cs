...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class InstrumentEntity : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public InstrumentEntity(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), SavedInstrumentMeta?  = default(SavedInstrumentMeta?))
        {
            this.customer_id = ;
            this.afa_reference = ;
            this.instrument_id = ;
