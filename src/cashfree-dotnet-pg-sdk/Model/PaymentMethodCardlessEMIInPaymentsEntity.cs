...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentMethodCardlessEMIInPaymentsEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodCardlessEMIInPaymentsEntity" /> class.
        /// </summary>
        /// <param name="">.</param>
        public PaymentMethodCardlessEMIInPaymentsEntity(PaymentMethodAppInPaymentsEntityApp?  = default(PaymentMethodAppInPaymentsEntityApp?))
        {
            this.cardless_emi = ;
        }
