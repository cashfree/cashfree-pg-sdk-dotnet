...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentWebhookErrorEntity : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public PaymentWebhookErrorEntity(string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?))
        {
            this.error_code = ;
