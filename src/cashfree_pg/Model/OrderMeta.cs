...
namespace cashfree_pg.Model
{
    ...
    public class OrderMeta : IEquatable<OrderMeta>, IValidatableObject
    {
        ...
        public OrderMeta(string? returnUrl = default(string?), string? notifyUrl = default(string?), Object? paymentMethods = default(Object?), OrderMetaPaymentMethodsFilters? paymentMethodsFilters = default(OrderMetaPaymentMethodsFilters?))
        {
        ...
        public bool Equals(OrderMeta input)
        {
            ...
            return 
                ...
                (
                    this.payment_methods_filters == input.payment_methods_filters ||
                    (this.payment_methods_filters != null &&
                    this.payment_methods_filters.Equals(input.payment_methods_filters))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.payment_methods_filters != null)
                {
                    hashCode = (hashCode * 59) + this.payment_methods_filters.GetHashCode();
                }
                return hashCode;
            }
        }
