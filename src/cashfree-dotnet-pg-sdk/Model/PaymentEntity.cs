...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class PaymentEntity : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="">Payment entity full object..</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        ...
        /// <param name="">.</param>
        /// <param name="">Issuing bank’s transaction reference number..</param>
        /// <param name="">Authorisation ID provided by the issuing bank..</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        public PaymentEntity(string?  = default(string?), string?  = default(string?), string?  = default(string?), ErrorDetailsInPaymentsEntity?  = default(ErrorDetailsInPaymentsEntity?), bool?  = default(bool?), decimal?  = default(decimal?), string?  = default(string?), string?  = default(string?), decimal?  = default(decimal?), string?  = default(string?), string?  = default(string?), PaymentStatusEnum?  = default(PaymentStatusEnum?), string?  = default(string?), string?  = default(string?), string?  = default(string?), string?  = default(string?), AuthorizationInPaymentsEntity?  = default(AuthorizationInPaymentsEntity?), PaymentEntityPaymentMethod?  = default(PaymentEntityPaymentMethod?), InternationalPaymentEntity?  = default(InternationalPaymentEntity?), PaymentGatewayDetails?  = default(PaymentGatewayDetails?), PaymentEntityPaymentSurcharge?  = default(PaymentEntityPaymentSurcharge?))
        {
            this.cf_payment_id = ;
            this.order_id = ;
            this.entity = ;
            ...
            this.authorization = ;
            this.payment_method = ;
            this.international_payment = ;
            this.payment_gateway_details = ;
            this.payment_surcharge = ;
        }

        /// <summary>
        /// Payment entity full object.
        /// </summary>
        /// <value>Payment entity full object.</value>
        ...
        /// </summary>
        /// <value>Issuing bank’s transaction reference number.</value>
        ...
        /// </summary>
        /// <value>Authorisation ID provided by the issuing bank.</value>
