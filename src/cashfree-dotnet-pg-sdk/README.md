...
inputSpec: pg/pgnextgenapi/2026-01-01.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{B39F658E-114C-48C6-B333-7BC9BC8AD2D3}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<ICustomersApi>();
            IPGCreateCustomerApiResponse apiResponse = await api.PGCreateCustomerAsync("todo");
            CustomerEntity? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Cashfree Payment Gateway APIs
- appVersion: 2026-01-01
- appDescription: Cashfree&#39;s Payment Gateway APIs provide developers with a streamlined pathway to integrate advanced payment processing capabilities into their applications, platforms and websites.
