...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class UpdateTerminalRequestTerminalMeta : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTerminalRequestTerminalMeta" /> class.
        /// </summary>
        /// <param name="">Name of the operator for the storefront..</param>
        public UpdateTerminalRequestTerminalMeta(string?  = default(string?))
        {
