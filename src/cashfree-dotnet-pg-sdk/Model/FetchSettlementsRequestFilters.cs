...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class FetchSettlementsRequestFilters : IValidatableObject
    {
        /// <summary>
        ...
        public FetchSettlementsRequestFilters(List<string>?  = default(List<string>?), List<string>?  = default(List<string>?), string?  = default(string?), string?  = default(string?))
        {
