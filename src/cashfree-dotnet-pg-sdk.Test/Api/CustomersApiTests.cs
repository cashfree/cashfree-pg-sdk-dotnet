...
namespace cashfree-dotnet-pg-sdk.Test.Api
{
    ...
    public sealed class CustomersApiTests : ApiTestsBase
    {
        ...
        public async Task PGCreateCustomerAsyncTest()
        {
            ...
            var response = await _instance.PGCreateCustomerAsync(createCustomerRequest, xApiVersion, xRequestId, xIdempotencyKey);
            var model = response.Ok();
            Assert.IsType<CustomerEntity>(model);
        }
    }
}
