...
namespace cashfree_pg.Model
{
    ...
    public class DemapSoundboxVpaRequest : IValidatableObject
    {
        ...
        /// <param name="deviceSerialNo">Device Serial No of soundbox that need to demap..</param>
        public DemapSoundboxVpaRequest(long cfTerminalId = default(long), string? deviceSerialNo = default(string?))
        {
