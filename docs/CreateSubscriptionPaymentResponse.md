...
**payment_initiated_date** | **string** | The date on which the payment was initiated. We store timestamps in IST. | [optional] 
...
**payment_method** | **string** | Payment method used for the authorisation. | [optional] 
