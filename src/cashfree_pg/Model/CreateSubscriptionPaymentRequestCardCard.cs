...
namespace cashfree_pg.Model
{
    ...
    public class CreateSubscriptionPaymentRequestCardCard : IValidatableObject
    {
        ...
        public CreateSubscriptionPaymentRequestCardCard(string? cardCvv = default(string?), string? cardExpiryMm = default(string?), string? cardExpiryYy = default(string?), string? cardHolderName = default(string?), string? cardNetwork = default(string?), string? cardNumber = default(string?), string? cardType = default(string?), string? channel = default(string?))
        {
