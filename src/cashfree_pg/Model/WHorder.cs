...
namespace cashfree_pg.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WHorder")]
    public class WHorder : IEquatable<WHorder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WHorder" /> class.
        /// </summary>
        ...
        public WHorder(string orderId = default(string), double orderAmount = default(double), string orderCurrency = default(string), Dictionary<string, string> orderTags = default(Dictionary<string, string>))
        {
        ...
        {
            return this.Equals(input as WHorder);
        }

        /// <summary>
        /// Returns true if WHorder instances are equal
        /// </summary>
        /// <param name="input">Instance of WHorder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WHorder input)
        {
            if (input == null)
            {
                return false;
