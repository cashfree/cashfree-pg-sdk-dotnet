...
namespace cashfree_pg.Model
{
    ...
    public class OrderCreateRefundRequest : IValidatableObject
    {
        ...
        /// <param name="refundId">An unique ID to associate the refund with. Provie alphanumeric values..</param>
        /// <param name="refundNote">A refund note for your reference. To simulate refund status in Sandbox, pass SUCCESS, FAILED, PENDING, or ACTIVE in the refund_note field. This is a case-sensitive parameter..</param>
        ...
        public OrderCreateRefundRequest(double refundAmount = default(double), string? refundId = default(string?), string? refundNote = default(string?), RefundSpeedEnum? refundSpeed = default(RefundSpeedEnum?), List<OrderCreateRefundRequestRefundSplitsInner>? refundSplits = default(List<OrderCreateRefundRequestRefundSplitsInner>?))
        {
