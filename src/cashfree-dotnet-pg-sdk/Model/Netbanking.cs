...
namespace cashfree-dotnet-pg-sdk.Model
{
    ...
    public class Netbanking : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Netbanking" /> class.
        /// </summary>
        /// <param name="">The channel for netbanking will always be &#x60;link&#x60;. (required).</param>
        /// <param name="">Bank code..</param>
        /// <param name="">String code for bank..</param>
        public Netbanking(string  = default(string), int?  = default(int?), string?  = default(string?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for Netbanking and cannot be null");
            }
            this.channel = ;
