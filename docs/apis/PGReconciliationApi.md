...
<a id="pgfetchrecon"></a>
# **PGFetchRecon**
> ReconEntity PGFetchRecon (FetchReconRequest fetchReconRequest, string xApiVersion, string contentType = null, string xRequestId = null, Guid xIdempotencyKey = null, string accept = null)
